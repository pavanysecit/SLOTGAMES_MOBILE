Feature: Test all the functionalities of Sea Pearl Slot Game
	...
	And The exact amount entered in the transfer page should transfer to Sea Pearl game and same amount should get displayed on the balance section
	And An error should be displayed if the balance field is empty and player should be blocked from loading the Sea Pearl game
	And An error should be displayed if balance entered was zero and player should be blocked from loading the Sea Pearl game
    ...
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.02 and check the bet value
    Then Bet value should get changed to 0.2,0.4,1,2,4 if the bet type selected as 0.02 from the drop down in Sea Pearl slot game
    ...
    Then Bet value should get changed to 0.5,1,2.5,5,10 if the bet type selected as 0.05 from the drop down 1 in Sea Pearl slot game
    ...
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, bet type as 0.1 from down 2 and bet value as 1,2,5,10,20
    ...
    Then Bet value should get changed to 1,2,5,10,20 if the bet type selected as 0.1 from the drop down two in Sea Pearl slot game
    ...
    Then Bet value should get changed to 5,10,25,50,100 if the bet type selected as 0.5 from the drop down three in Sea Pearl slot game
	...
	Scenario: Change the bet value as 0.5, do the spin and check whether balance is deducting according to the changed bet type in Sea Pearl slot game
    Given Chrome browser, valid URL, valid login details, Sea Pearl game, 0.05 as bet type , 0.5 as bet value, balance, spin button and win amount
	...
	Scenario: Change the bet type as 0.05 from drop down & bet value to ONE do the spin and check whether balance is deducting according to the changed bet type in Sea Pearl slot game
    ...
    Then Balance should get deducted by ONE if the bet type is selected as 0.05 in Sea Pearl hot game
	
	
	Scenario: Change the bet value as 2.5, do the spin and check whether balance is deducting according to changed bet type in Sea Pearl slot game
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, bet type as 0.05, bet value drop down, bet value as 2.5, balance and spin button
    When Open the Sea Pearlslot slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.05, select the bet value as 2.5, click on spin button and check the balance
    Then Current Balance should get deducted by 2.5 as bet type is selected as 0.05 & bet value as 2.5 in Sea Pearl slot game
	
	
	Scenario: Change the bet value to FIVE, click on spin button and check whether current balance is deducting according to changed bet type in Sea Pearl slot game
    ...
    Then Existing Balance should get deducted by TEN as bet type is selected as 0.05 & bet value as 10 in Sea Pearl slot game
	...
	Scenario: Change the bet value as 2, do the spin and check whether balance is deducting according to the changed bet type 0.1 in Sea Pearl slot game
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, bet type as 0.1 from drop down, bet value as 2, balance and spin button
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 2 from drop down, click on spin button and check the balance
    Then Balance should get deducted by 2 if bet type is selected as 0.1 & bet value as 2 in Sea Pearl game
    ...
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, select the bet type as TEN from bet type drop down, click on spin button and check the balance
    ...
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, select the bet type as twenty from bet type drop down, click on spin button and check the balance
	...
	Scenario: Change the bet value as 5, do the spin and check whether balance is deducting according to the changed bet type 0.5 in Sea Pearl slot game
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, bet type as 0.5, bet value as Five , balance and spin button
    ...
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, bet type as 0.5, bet value as TEN, balance and spin buttone
	...
	Scenario: Change the bet value as 25, do the spin and check whether balance is deducting according to the changed bet type 0.5 in Sea Pearl slot game
    Given Chrome browser, valid URL, valid login details, Sea Pearl game, bet type as 0.5, bet value as 25, balance and spin button
    When Open the Sea Pearl game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.5 & bet value as 25, click on spin button and check the balance
    Then Balance should get deducted by 25 as bet type is selected as 0.5 in Sea Pearl game
	...
	Scenario: Change the bet value as 100, do the spin and check whether balance is deducting according to the changed bet type 0.5 in Sea Pearl slot game
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, bet type as 0.5, bet value as 100, balance and spin button
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.5 & bet value as 100, click on spin button and check the balance
    ...
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.01, select the bet value as TEN, click on spin button and check the balance in credits
    Then Balance should get deducted by TEN as bet type is selected as 0.01 and bet value as 10 in Sea Pearl game
	
	
	 Scenario: Change the bet value as TWENTY, do the spin and check whether balance in credits is deducting according to the changed bet type in Sea Pearl slot game
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, bet type as 0.01, bet value as TWENTY, balance in credits and spin button
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.01, select the bet value as TWENTY, click on spin button and check the balance in credits
    Then Balance should get deducted by TWENTY, as bet type is selected as 0.01 and bet value as 20 in Sea Pearl game
	
	
	 Scenario: Change the bet value as FIFTY, do the spin and check whether balance in credits is deducting according to the changed bet type in Sea Pearl slot game
    ...
    When Open the Sea Pearl game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.01, select the bet value as FIFTY, click on spin button and check the balance in credits
    Then Balance should get deducted by FIFTY, as bet type is selected as 0.01 and bet value as 50 in Sea Pearl game
	
	
	Scenario: Change the bet value as HUNDRED do the spin and check whether balance in credits is deducting according to the changed bet type in Sea Pearl slot game
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, bet type as 0.01, bet value as HUNDRED, balance in credits and spin button
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.01, select the bet value as HUNDRED, click on spin button and check the balance in credits
    Then Balance should get deducted by HUNDRED as bet type is selected as 0.01 and bet value as 100 in Sea Pearl game
	
	
	 Scenario: Change the bet value as TWO HUNDRED, do the spin and check whether balance in credits is deducting according to the changed bet type in Sea Pearl slot game
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, bet type as 0.01, bet value as TWO HUNDRED, balance in credits and spin button
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.01, select the bet value as TWO HUNDRED, click on spin button and check the balance in credits
    Then Balance should get deducted by TWO HUNDRED, as bet type is selected as 0.01 and bet value as 200 in Sea Pearl game
    ...
    Then Balance amound should be same as denomination 0.02 multiplies by credit in Sea Pearl slot game
    ...
    Then Balance amound should be same as denomination 0.05 multiplies by credit in Sea Pearl game
    ...
    Then Balance amound should be same as denomination 0.1 multiplies by credit balance in Sea Pearl slot game
    ...
    When Open the Sea Pearl hot slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on Sea Pearl slot game, click on spin button till player wins, click on balance, check the win amount and click on balance
    ...
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, transfer the amount, click on spin button till user win and check the balance after win in Sea Pearl slot game
    Then Win amount should get added to the balance after win and balance should get increased with win amount in Sea Pearl slot game
	
	

	Scenario: Check whether winning amount is getting added to the main balance in credits
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, balance, transfer button, credit balance form, spin button and win amount in credits
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, transfer the amount, click on  balance window to change to credit form, click on spin button till user win and check the balance after win in credits
    Then Win amount should get added to the credit field after win and credit should get increased with win amount in Sea Pearl slot game
	
	


	
	 Scenario: Check whether user able to play the game when there is insufficiant balance in balance counter the bet and credit values are decreased to equal or less than available balance which enables player to resume the game in Sea Pearl slot game
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, balance counter, Auto spin button, validation message, credit types and bet types
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on Auto spin button till balance counter turns less than betvalues and check the insufficient validation message and reduce the bet and credit values to resume the play.
    Then Player should be blocked from playing the game when there is less amount in balance counter and reducing the credit and bet types player is enable to continue slot game in Sea Pearl game
    ...
    When Open the Sea Pearl hot slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on spin button and check the user instruction messages
    Then User instruction message 'Please place your bet' should be displayed before spin button is clicked 
	And User instruction message 'Good Luck' should be displayed after spin button is clicked in Sea Pearl slot game
    ...
    Then Number of spin left should start from 9 to 1 after clicking ten spins option and should perform 10 spins from 9 to 1 in Sea Pearl slot game
	...
	Scenario: Check bet value, credit value, home button, info button, play button behavior during autoplay in Sea Pearl game
    Given Chrome browser, valid URL, valid login details, Sea Pearl game, balance, spin button, auto spin button, auto spins option and check for buttons behavior & functionality
    When Open the Sea Pearl game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on auto spin option under auto spin drop down and check behavior of different buttons in different scenarios
    Then Bet value & Credit value buttons should not be clickable in Sea Pearl game
	And Home and Info buttons should not be clickable in Sea Pearl game
	And Spin button should not visible & Stop button should be visible and clickable in Sea Pearl game
	And Spin button should be visble after clicking on stop button in in Sea Pearl game
    
    
    Scenario: Check bet & credit value buttons behavior after navigating from gamble page during autoplay and check win amount getting added to balance in Sea Pearl game
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, balance, spin button, auto spin button, auto spins option and check for buttons behavior & functionality after navigating from gamble page to game page
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on auto spin option under auto spin drop down and check behavior of different buttons after navigating from gamble page to game page in Sea Pearl game
    Then Bet value & Credit value buttons should not be clickable after navigating from gamble page in Sea Pearl game
	And Win amount should get added to the balance during autoplay in Sea Pearl game
 
    
    Scenario: Check whether auto spin is continued even after switching between the tabs inside a browser session of Sea Pearl slot game
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, spin button, auto spin button, browser tabs.
    When Open the Sea Pearl slot game by entering the valid URL in browser, click on auto wait for the reel spin, open new browser tabs and redirect to game tab and check the spin functionality
    Then Auto spin should be continued even after switching between the tabs in Sea Pearl slot game
	...
	Scenario: Check whether the max payout amount for each symbol as per the bet type 0.02 and denomination 0.2 in Sea Pearl slot game on mobile
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, icon to open payout table, all symbols, max amount on each symbol, back button, bet type 0.02 and deominations 0.2 
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on icon to open payout table, check payout amount on each symbol, click on back button, select bet type as 0.02 & deominations as 0.2 and check payout amount
    Then System should display the Payout max amount on each symbol and payout max amount should get changed whenever player changes the bet type to 0.02 and deomination to 0.2 in Sea Pearl slot game on mobile
	
	
	Scenario: Check whether the max payout amount for each symbol as per the bet type 0.02 and denomination 0.4 in Sea Pearl slot game on mobile
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, icon to open payout table, all symbols, max amount on each symbol, back button, bet type 0.02 and  denomination value as 0.4
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on icon to open payout table, check payout amount on each symbol, click on back button, select bet type as 0.02 & denomination  values as 0.4 and check payout amount
    Then System should display the Payout max amount on each symbol and payout max amount should get changed whenever player changes the bet type to 0.02 and denomination value as 0.4 in Sea Pearl slot game on mobile
	
	
	Scenario: Check whether the max payout amount for each symbol like A, K, 10 as per the bet type 0.02 and denomination as ONE in Sea Pearl slot game on mobile
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, icon to open payout table, all symbols, max amount on each symbol like A, K, 10 n etc, back button, bet type 0.02 and denomination as ONE on mobile
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on icon to open payout table, check payout amount on each symbol like A, K, 10 n etc, click on back button, select bet type as 0.02 & denomination as ONE and check payout amount on mobile
    Then System should display the Payout max amount on each symbol like A, K, 10 n etc and payout max amount should get changed whenever player changes the bet type to 0.02 and denomination to ONE in Sea Pearl slot game on mobile
	
	
	Scenario: Check whether the max payout amount for each symbol like J, Wild as per the bet type 0.02 and denomination TWO in Sea Pearl slot game on mobile
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, icon to open payout table, all symbols, max amount on each symbol like J, Wild n etc, back button, bet type 0.02 and denomination as TWO on mobile
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on icon to open payout table, check payout amount on each symbol like J, Wild n etc, click on back button, select bet type as 0.02 & denomination value as TWO and check payout amount on mobile
    Then System should display the Payout max amount on each symbol like J, Wild n etc and payout max amount should get changed whenever player changes the bet type to 0.02 and denomination value to TWO in Sea Pearl slot game on mobile
	
	
	Scenario: Check whether the max payout amount for each symbol like J, Wild as per the bet type 0.02 and denomination FOUR in Sea Pearl slot game on mobile
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, icon to open payout table, all symbols, max amount on each symbol like J, Wild n etc, back button, bet type 0.02 and denomination as FOUR on mobile
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on icon to open payout table, check payout amount on each symbol like J, Wild n etc, click on back button, select bet type as 0.02 & denomination value as FOUR and check payout amount on mobile
    Then System should display the Payout max amount on each symbol like J, Wild n etc and payout max amount should get changed whenever player changes the bet type to 0.02 and denomination value to FOUR in Sea Pearl slot game on mobile
	
	
	

		
	Scenario: Checking whether win amount is displaying as gamble amount in gamble page of Sea Pearl slot game 
    ...
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on spin button till player wins, click on gamble button and check the gamble amount
    Then Win amount should be displayed as Gamble amount in the gamble page of the Sea Pearl slot game
	
	Scenario: Checking Gamble to Win amount should be double than gamble amount in gamble page of Sea Pearl slot game 
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, balance, spin button, win amount, gamble button, gamble amount and gamble to win amount
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on golden hot slot game, click on spin button till player wins, click on gamble button and check the gamble to win amount
    Then Gamble To Win amount should be double than Gamble amount in the gamble page of the Sea Pearl slot game
	...
	Then Gamble page should provide multiple options for the user to play and enabled to play in landscape mode and check the win meter in main page in Sea Pearl slot game 
	

	Scenario: Check whether gamble credit win amount is getting added to the balance after win in Sea Pearl game 
	Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, credit balance, spin button, credit win amount, gamble button, gamble amount in credits, red button, black button and gamble status
	When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, click on spin button till player wins, click on gamble button, click on red or black button and check the balance in credits after win
	Then verify the credit form of currency in gamble page on all fields 
	Then Gamble credit Win amount should get added to main balance after status displayed as WIN and gamble page should get closed in Sea Pearl slot game
	

	Scenario: Check whether resume feature is enabled in Gamble screen, when user collect amount in gamble screen without playing Gamble attempts in Sea Pearl slot game
	Given chrome browser, valid URL, valid login details, Sea Pearl slot slot game, bet type, denomination, balance, spin button, Gamble screen, Gamble collect
	When Open the Sea Pearl slot slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, select bet type & denomination, click on spin button till win appears and gamble screen in switched and click on collect and close the browser and again load to the game 
	Then  Resume feature should not be enabled and land on the game screen of Sea Pearl slot game
	
	
	Scenario: Check whether resume feature is enabled in Gamble screen of Sea Pearl slot game
	Given Chrome browser, valid URL, valid login details, Sea Pearl slot slot game, bet type, denomination, balance, spin button, Gamble screen, new browser session.
	When Open the Sea Pearl slot slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, select bet type & denomination, click on spin button till win appears and gamble screen in switched and click on red button and close the browser and again login to the game with new browser
	Then  Resume feature should enabled and land on the gamble screen of Sea Pearl slot game
	Then  On resuming to gamble screen, collect the amount and verify with main  balance addition and win meter amount same as gamble amount in gamble page in  Sea Pearl slot game
	
	
	Scenario: Check whether on resume feature is enabled in Gamble screen, user can play further left over attempts and check the attempts before and after resuming to gamble screen in Sea Pearl slot game
	Given chrome browser, valid URL, valid login details, Sea Pearl slot slot game, bet type, denomination, balance, spin button, Gamble screen, Gamble attempts, gamble play
	When Open the Sea Pearl slot slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, select bet type & denomination, click on spin button till win appears and gamble screen in switched and click on black button and close the browser and again login to the game with new browser
	Then  Resume feature should be enabled and land on the game screen and verify with the left out gamble attempts of Sea Pearl slot game
    ...
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, select bet type as 0.02 & denomination as 0.2, click on spin button till player wins, click on gamble button and check the gamble count
    Then Gamble count should be displayed based on win amount and gamble max amount configured on the game info page for bet type 0.02 & denomination 0.2 in Sea Pearl game
    ...
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on golden hot slot game, select bet type as 0.02 & denomination as 0.4, click on spin button till player wins, click on gamble button and check the gamble count in gamble page
    Then Gamble count should be displayed on gamble page based on win amount and gamble max amount configured on the game info page for bet type 0.02 & denomination 0.4 Sea Pearl game
    ...
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on golden hot slot game, select bet type as 0.02 & denomination as ONE, click on spin button till player wins, click on gamble button and check the gamble count in gamble page of slot game
    Then Gamble count should be displayed  on gamble page of slot game based on win amount and gamble max amount configured on the game info page for bet type 0.02 & denomination ONE in Sea Pearl game
    ...
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on golden hot slot game, transfer the amount, select bet type as 0.02 & denomination as TWO, click on spin button till player wins, click on gamble button and check the gamble count
    Then Gamble count should be displayed based on winning amount and max amount of the gamble configured on the game info page for bet type 0.02 and denomination TWO in Sea Pearl game
    ...
    When Open the Sea Pearl slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on golden hot slot game, select bet type as 0.02 & denomination as FOUR, click on spin button till player wins, click on gamble button and check the gamble count
...
#13. SeaPearl_Reload_Option 
    ...
    Then Amount should get deducted from balance on click on spin button in try now page of Sea Pearlslot game
	
	
	Scenario: Check whether winning amount is gettting added to the balance when the player wins in try now page of Sea Pearl slot game
    Given Chrome browser, valid URL, valid login details, Sea Pearl slot game, try now button, balance to play, spin button and win amount
    When Open the Sea Pearl slot game by entering the valid URL in browser, click on try now button, click on spin button till player win and check the balance after win
    Then Win amount should get added to the balance when the player wins in try now page of Sea Pearl slot game