Feature: Test all the functionalities of Soccer Mania Slot Game
	...
	Scenario: Select the bet type as 0.02 from the drop down and check the bet value should be 0.6,1.2,3,6 & 12 in Soccer Mania slot game
    Given Chrome browser, valid URL, valid login details, Soccer Mania game, bet type as 0.02 and bet value as 0.6,1.2,3,6 & 12
    When Open the Soccer Mania slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.02 and check the bet value should be 0.6,1.2,3,6 & 12
    Then Bet value should get changed to 0.6,1.2,3,6 & 12 if the bet type selected as 0.02 from the drop down 1 in Soccer Mania slot game
	...
	Scenario: Select the bet type as 0.5 from the drop down and check the bet value should be 15,30,75,150 & 300 in Soccer Mania slot game
    Given Chrome browser, valid URL, valid login details, Soccer Mania slot game, bet type as 0.5 from drop down and bet value as 15,30,75,150 & 300
    When Open the Soccer Mania slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.5 from drop down and check the bet value should be 15,30,75,150 & 300
    Then Bet value should get changed to 15,30,75,150 & 300 if the bet type selected as 0.5 from the drop down three in Soccer Mania slot game
	...
	Scenario: Change the bet value as 0.6, do the spin and check whether balance is deducting according to the changed bet type in Soccer Mania game
    Given Chrome browser, valid URL, valid login details, Soccer Mania game, 0.02 as bet type , 0.6 as bet value, balance, spin button and balance after spin
    When Open the Soccer Mania game by entering the valid URL in browser, enter the valid login details, select the bet value to 0.6, click on spin button and check the balance
    Then Balance should get deducted by 0.6 as bet type is selected as 0.02 and bet value as 0.6 in Soccer Mania game
	
	
	Scenario: Change the bet type as 0.02 from drop down & bet value to 1.2 do the spin and check whether balance is deducting according to the changed bet type in Soccer Mania slot game
    Given Chrome browser, valid URL, valid login details, Soccer Mania slot game, bet type & bet value drop down, bet type as 0.02, bet value as 1.2, balance and spin button
    When Open the Soccer Mania slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.02 from drop down, bet value to 1.2 click on spin button and check the balance after spin
    Then Balance should get deducted by 1.2 if the bet type is selected as 0.02 and bet value as 1.2 in Soccer Mania hot game
	
	
	Scenario: Change the bet value as 3, do the spin and check whether balance is deducting according to changed bet type in Soccer Mania slot game
    Given Chrome browser, valid URL, valid login details, Soccer Mania game, bet type as 0.02, bet value as 3, balance and spin button
    When Open the Soccer Maniaslot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.02, select the bet value as 3, click on spin button and check the balance
    Then Current Balance should get deducted by 3 as bet type is selected as 0.02 & bet value as 3 in Soccer Mania game
	
	
	Scenario: Change the bet value to SIX, click on spin button and check whether current balance is deducting according to changed bet type in Soccer Mania slot game
    Given Chrome browser, valid URL, valid login details, Soccer Mania slot game, bet type as 0.02, bet value as SIX, bet type & bet values drop down, balance, spin button and balance amount
    When Open the Soccer Mania slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.02, select the bet value to SIX, click on spin button and check the balance
    Then Current Balance should get deducted by 6 as bet type is selected as 0.02 & bet type as SIX in Soccer Mania game
	
	Scenario: Change the bet value as 12, click on spin and check whether existing balance is deducting according to changed bet type in Soccer Mania slot game
    Given Chrome browser, valid URL, valid login details, Soccer Mania game, bet type as 0.02, bet value as 12, bet value drop down, balance and spin button
    When Open the Soccer Mania slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.02, select the bet value to 12, click on spin button and check the Soccer Mania slot game balance
    Then Existing Balance should get deducted by 12 as bet type is selected as 0.02 & bet value as 12 in Soccer Mania slot game
	...
	Scenario: Change the bet value as fifteen(15), do the spin and check whether balance is deducting according to the changed bet type 0.5 in Soccer Mania slot game
    Given Chrome browser, valid URL, valid login details, Soccer Mania slot game, bet type as 0.5, bet value as fifteen(15), balance and spin buttone
    When Open the Soccer Mania slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.5 & bet value as fifteen(15), click on spin button and check the balance
    Then Balance should get deducted by fifteen(15) as bet type is selected as 0.5 in Soccer Mania game
	
	
	Scenario: Change the bet value as thirty(30), do the spin and check whether balance is deducting according to the changed bet type 0.5 in Soccer Mania slot game
    Given Chrome browser, valid URL, valid login details, Soccer Mania slot game, bet type as 0.5, bet value as thirty(30), balance and spin button
    When Open the Soccer Mania slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.5 & bet value as thirty(30), click on spin button and check the balance
    Then Balance should get deducted by thirty(30) as bet type is selected as 0.5 in Soccer Mania game
	
	
	Scenario: Change the bet value as seventy five(75), do the spin and check whether balance is deducting according to the changed bet type 0.5 in Soccer Mania slot game
    Given Chrome browser, valid URL, valid login details, Soccer Mania slot game, bet type as 0.5, bet value as seventy five(75), balance and spin button
    When Open the Soccer Mania slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.5 & bet value as seventy five(75), click on spin button and check the balance
    Then Balance should get deducted by seventy five(75) as bet type is selected as 0.5 in Soccer Mania game
	
	Scenario: Change the bet value as 100, do the spin and check whether balance is deducting according to the changed bet type 0.5 in Soccer Mania slot game
    Given Chrome browser, valid URL, valid login details, Soccer Mania slot game, bet type as 0.5, bet value as 100, balance and spin button
    When Open the Soccer Mania slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.5 & bet value as 100, click on spin button and check the balance
    Then Balance should get deducted by 100 as bet type is selected as 0.5 in Soccer Mania game
	
	Scenario: Change the bet value as two hundred, do the spin and check whether balance is deducting according to the changed bet type 0.5 in Soccer Mania slot game
    Given Chrome browser, valid URL, valid login details, Soccer Mania slot game, bet type as 0.5, bet value as two hundred, balance and spin button
    When Open the Soccer Mania slot game by entering the valid URL in browser, enter the valid login details, select the bet type as 0.5 & bet value as two hundred, click on spin button and check the balance
    Then Balance should get deducted by two hundred as bet type is selected as 0.5 in Soccer Mania game
	...
	Scenario: Check whether balance is equals to credit multiplies by denomination 0.5 in Soccer Mania slot game
    Given Chrome browser, valid URL, valid login details, Soccer Mania slot game, balance, credits and denomination drop down & value as 0.5 
    When Open the Soccer Mania slot game by entering the valid URL in browser, enter the valid login details, click on balance, multiply credit by denomination 0.5 manually with and check the balance
    Then Balance amount should be same after multiplying denomination 0.5 by credit in Soccer Mania slot game
    ...
    When Open the 40 Glowing hot slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on Soccer Mania slot game, click on spin button till player wins, click on balance, check the win amount and click on balance
	...
	Scenario: Check whether user able to play the game when there is insufficiant balance in account in Soccer Mania slot game
    Given Chrome browser, valid URL, valid login details, Soccer Mania slot game, balance, spin button and validation message
    When Open the Soccer Mania slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on spin button till balance turns to zero and check the validation message
    Then Player should be blocked from playing the game when there is no balance in the account in Soccer Mania game
