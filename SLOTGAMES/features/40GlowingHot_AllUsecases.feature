Feature: Test all the functionalities of 40 Glowing Hot Slot Game
    ...
    Given Chrome browser, valid URL, valid by entering the valid URL in browser, enter the valid login details, select the bet type as 0.02 and check the bet value should be 0.8, 1.6, 4,8,10
