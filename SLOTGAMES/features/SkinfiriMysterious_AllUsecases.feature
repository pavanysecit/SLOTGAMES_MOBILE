Feature: Test all the functionalities of Skinfiri Mysterious Slot Game
	...
	Scenario: Check whether balance field is accepting null valuess in the transfer page of Skinfiri Mysterious game in mobile
    Given Chrome browser, valid URL, valid login details, Skinfiri Mysterious game, empty balance, text field to transfer balance, Ok button and validation message in mobile
    When Open the Skinfiri Mysterious slot game by entering the valid URL in browser, enter the valid login details,  do not enter the amount in the balance field and click on Ok butotn in mobile
    Then An error should be displayed if the balance field is empty and player should be blocked from loading the Skinfiri Mysterious game in mobile
