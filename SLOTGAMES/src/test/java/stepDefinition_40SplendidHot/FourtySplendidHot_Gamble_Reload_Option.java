...
public class FourtySplendidHot_Gamble_Reload_Option {
	AppiumDriver<MobileElement> driver;

	public FourtySplendidHot_Gamble_Reload_Option() throws InterruptedException {
		this.driver = FourtySplendidHot_URL_Login.getDriver();
		//this.driver = FourtySplendidHot_URL_TryNow.getDriver();
		}
	
	@Given("^Chrome browser, valid URL, valid login details, (\\d+) Splendid Hot slot game, balance, spin button, gamble page, browser hamburger reload button valid session invalid error message\\.$")
	public void chrome_browser_valid_URL_valid_login_details_Splendid_Hot_slot_game_balance_spin_button_gamble_page_browser_hamburger_reload_button_valid_session_invalid_error_message(int arg1) throws Throwable {
	    
	}

	@When("^Open the (\\d+) Splendid Hot slot game by entering the valid URL in browser, enter the valid login details, spin till player wins, gamble screen, gamble should won,  click on  hamburger menu and reload the game session\\.$")
	public void open_the_Splendid_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_spin_till_player_wins_gamble_screen_gamble_should_won_click_on_hamburger_menu_and_reload_the_game_session(int arg1) throws Throwable {
	...
	@Then("^User should not able to resume to game and informed with valid error message for session invalid error message and again relauch the game and game session redirected to gamble page in (\\d+) Splendid Hot slot game$")
	public void user_should_not_able_to_resume_to_game_and_informed_with_valid_error_message_for_session_invalid_error_message_and_again_relauch_the_game_and_game_session_redirected_to_gamble_page_in_Splendid_Hot_slot_game(int arg1) throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
