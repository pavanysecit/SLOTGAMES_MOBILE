...
public class BlazingHot_Balance_Deduction_InCredits_AccordingToBetType1_3 {
	...
	@When("^Open the Blazing Hot game by entering the valid URL in browser, enter the valid login details, select the bet type as (\\d+)\\.(\\d+), select the bet value as (\\d+), click on spin button and check the balance in credits$")
	public void open_the_Blazing_Hot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_select_the_bet_value_as_click_on_spin_button_and_check_the_balance_in_credits(int arg1, int arg2, int arg3) throws Throwable {
