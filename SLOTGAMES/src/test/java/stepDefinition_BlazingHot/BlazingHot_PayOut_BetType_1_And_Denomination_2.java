...
public class BlazingHot_PayOut_BetType_1_And_Denomination_2 {
	AppiumDriver<MobileElement> driver;

	public BlazingHot_PayOut_BetType_1_And_Denomination_2() throws InterruptedException {
	...
	public void system_should_display_the_Payout_max_amount_on_each_symbol_like_bar_and_payout_max_amount_should_get_changed_whenever_player_changes_the_bet_type_to_and_denomination_value_as_in_Blazing_Hot_slot_game_on_mobile(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
