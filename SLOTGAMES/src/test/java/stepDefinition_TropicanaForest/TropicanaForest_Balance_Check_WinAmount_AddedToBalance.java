...
public class TropicanaForest_Balance_Check_WinAmount_AddedToBalance {
	AppiumDriver<MobileElement> driver;

	public TropicanaForest_Balance_Check_WinAmount_AddedToBalance() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropicana_Forest_slot_game_balance_transfer_button_spin_button_and_win_amount() throws Throwable {
	...
	public void open_the_Tropicana_Forest_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_amount_click_on_spin_button_till_user_win_and_check_the_balance_after_win_in_Tropicana_Forest_slot_game() throws Throwable {
	...
	public void win_amount_should_get_added_to_the_balance_after_win_and_balance_should_get_increased_with_win_amount_in_Tropicana_Forest_slot_game() throws Throwable {
		Thread.sleep(1000);
		driver.quit();
	}
}
