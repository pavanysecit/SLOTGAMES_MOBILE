...
public class TropicanaForest_AutoSpin_Validations_SwitchingTabs {
	AppiumDriver<MobileElement> driver;

	public TropicanaForest_AutoSpin_Validations_SwitchingTabs() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropicana_Forest_slot_game_spin_button_auto_spin_button_browser_tabs() throws Throwable {
	...
	public void open_the_Tropicana_Forest_slot_game_by_entering_the_valid_URL_in_browser_click_on_auto_wait_for_the_reel_spin_open_new_browser_tabs_and_redirect_to_game_tab_and_check_the_spin_functionality() throws Throwable {
	...
	public void auto_spin_should_be_continued_even_after_switching_between_the_tabs_in_Tropicana_Forest_slot_game() throws Throwable {
		Thread.sleep(1000);
		driver.quit();
	}
}
