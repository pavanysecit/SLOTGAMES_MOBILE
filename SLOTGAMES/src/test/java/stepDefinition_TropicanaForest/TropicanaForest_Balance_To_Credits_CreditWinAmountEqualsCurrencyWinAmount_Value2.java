...
public class TropicanaForest_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value2 {
	AppiumDriver<MobileElement> driver;

	public TropicanaForest_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value2() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropicana_Forest_slot_game_balance_spin_button_win_amount_in_currency_credits_and_win_amount_in_credits_for_denomination_drop_down_value_two() throws Throwable {
	...
	public void open_the_Tropicana_Forest_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_the_denomination_drop_down_value_two_click_on_spin_button_till_player_wins_click_on_balance_check_the_win_amount_and_click_on_balance() throws Throwable {
	...
	public void win_amount_in_credit_multiplied_by_denomination_drop_down_value_two_is_equal_to_win_amount_in_currency_in_Tropicana_Forest_slot_game() throws Throwable {
		Thread.sleep(1000);
		driver.quit();
	}
}