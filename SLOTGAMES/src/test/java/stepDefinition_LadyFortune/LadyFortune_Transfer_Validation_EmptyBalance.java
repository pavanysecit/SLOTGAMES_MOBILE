...
public class LadyFortune_Transfer_Validation_EmptyBalance {
	AppiumDriver<MobileElement> driver;

	public LadyFortune_Transfer_Validation_EmptyBalance() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Lady_Fortune_game_empty_balance_text_field_to_transfer_balance_Ok_button_and_validation_message_in_mobile() throws Throwable {
	...
	public void open_the_Lady_Fortune_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_do_not_enter_the_amount_in_the_balance_field_and_click_on_Ok_butotn_in_mobile() throws Throwable {
	...
	public void an_error_should_be_displayed_if_the_balance_field_is_empty_and_player_should_be_blocked_from_loading_the_Lady_Fortune_game_in_mobile() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
