...
public class LadyFortune_AutoSpin_Validations_GamblePage {
	AppiumDriver<MobileElement> driver;

	public LadyFortune_AutoSpin_Validations_GamblePage() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Lady_Fortune_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_check_for_buttons_behavior_functionality_after_navigating_from_gamble_page_to_game_page() throws Throwable {
	...
	public void open_the_Lady_Fortune_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_behavior_of_different_buttons_after_navigating_from_gamble_page_to_game_page_in_Lady_Fortune_game() throws Throwable {
	...
	public void bet_value_Credit_value_buttons_should_not_be_clickable_after_navigating_from_gamble_page_in_Lady_Fortune_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Win amount should get added to the balance during autoplay in Lady Fortune game$")
	public void win_amount_should_get_added_to_the_balance_during_autoplay_in_Lady_Fortune_game() throws Throwable {
		Thread.sleep(1000);
	    driver.quit();
	}
}