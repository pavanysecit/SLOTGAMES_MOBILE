...
public class LadyFortune_Balance_Credits_Calculations_Value1 {
	AppiumDriver<MobileElement> driver;

	public LadyFortune_Balance_Credits_Calculations_Value1() throws InterruptedException {
	...
	@Then("^Balance amound should be same as denomination (\\d+)\\.(\\d+) multiplies by credit in Lady Fortune slot game$")
	public void balance_amound_should_be_same_as_denomination_multiplies_by_credit_in_Lady_Fortune_slot_game(int arg1, int arg2) throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
