...
public class FrozenFruits_Balance_CreditBalance_For_IncrementalAndDecremental_CreditValue {
	AppiumDriver<MobileElement> driver;

	public FrozenFruits_Balance_CreditBalance_For_IncrementalAndDecremental_CreditValue() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Frozen_Fruits_slot_game_increment_decrement_and_balance_balance_in_credit_form_creditvalues() throws Throwable {
	...
	public void open_the_Frozen_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_inc_and_dec_credit_balance_and_verify_the_balance_in_credit_form_and_verify_the_balance() throws Throwable {
	...
	public void credit_balance_for_all_credit_values_should_be_same_as_balance_multiplies_by_credit_value_are_assigned_respectively_in_Frozen_Fruits_slot_game() throws Throwable {
	   Thread.sleep(2000);
	   driver.quit();
	}
}