...
public class FrozenFruits_Check_BetType_BetValue_DropDown_For_IncrementalAndDecremental_CreditValue {
	AppiumDriver<MobileElement> driver;

	public FrozenFruits_Check_BetType_BetValue_DropDown_For_IncrementalAndDecremental_CreditValue() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Frozen_Fruits_slot_game_increment_decrement_and_betvalue_amount() throws Throwable {
	...
	public void open_the_Frozen_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_inc_and_dec_credit_and_verify_the_betvalue_assigned_respectively() throws Throwable {
	...
	public void bet_amount_for_all_credit_values_should_be_assigned_respectively_in_Frozen_Fruits_slot_game() throws Throwable {
	   Thread.sleep(2000);
	   driver.quit();
	}
}