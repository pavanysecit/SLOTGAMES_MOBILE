...
public class FrozenFruits_Balance_Check_MaxBet_WinAmount_AddedTo_Balance {
	AppiumDriver<MobileElement> driver;

	public FrozenFruits_Balance_Check_MaxBet_WinAmount_AddedTo_Balance() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Frozen_Fruits_slot_game_balance_spin_button_gamble_collect_max_credit_and_bet_value_win_amount_added_to_balance() throws Throwable {
	...
	public void open_the_Frozen_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_spin_till_player_wins_gamble_screen_gamble_collect_win_amount_added_to_main_balance() throws Throwable {
	...
	public void maxbet_Win_amount_should_get_added_to_the_main_balance_after_win_and_balance_should_get_increased_with_win_amount_in_Frozen_Fruits_slot_game() throws Throwable {
	   Thread.sleep(2000);
	   driver.quit();
	}
}
