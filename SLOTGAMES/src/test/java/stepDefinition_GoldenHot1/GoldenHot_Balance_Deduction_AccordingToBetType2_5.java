...
public class GoldenHot_Balance_Deduction_AccordingToBetType2_5 {
	...
	@When("^Open the Golden hot slot game by entering the valid URL in browser, enter the valid login details, select the bet type as (\\d+)\\.(\\d+), select the bet value as FIVE, click on spin button and check the balance$")
	public void open_the_Golden_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_select_the_bet_value_as_FIVE_click_on_spin_button_and_check_the_balance(int arg1, int arg2) throws Throwable {
