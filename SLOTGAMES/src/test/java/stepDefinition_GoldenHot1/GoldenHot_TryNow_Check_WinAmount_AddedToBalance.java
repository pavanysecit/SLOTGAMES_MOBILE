...
public class GoldenHot_TryNow_Check_WinAmount_AddedToBalance {
...
private MobileElement prq;	
	...
	public void chrome_browser_valid_URL_valid_login_details_godlen_hot_slot_game_try_now_button_balance_to_play_spin_button_and_win_amount() throws Throwable {
		...
		driver.findElement(By.xpath("/html/body/div[3]/div[1]/ui-view/section/section[1]/div/div/div[2]/div[3]/ul/li[6]/div[2]/div[2]")).click();
	    Thread.sleep(40000);
	...
	public void open_the_Golded_hot_slot_game_by_entering_the_valid_URL_in_browser_click_on_try_now_button_click_on_spin_button_till_player_win_and_check_the_balance_after_win() throws Throwable {
...
//		}
	    ...
	    String pq="";
	    String paq=pq+dbi;
	    System.out.println("Final Win Amount: "+paq);
	...
	public void win_amount_should_get_added_to_the_balance_when_the_player_wins_in_try_now_page_of_golden_hot_slot_game() throws Throwable {
