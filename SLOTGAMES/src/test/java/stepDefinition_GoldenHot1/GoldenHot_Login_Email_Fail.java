...
public class GoldenHot_Login_Email_Fail {
AppiumDriver<MobileElement> driver;
	
	@Given("^Chrome browser, valid URL, Go button, Invalid email id, valid password and login button$")
	public void chrome_browser_valid_URL_Go_button_Invalid_email_id_valid_password_and_login_button() throws Throwable {
	...
	public void open_the_chrome_browser_Enter_the_valid_URL_click_on_Go_button_click_on_golden_hot_game_enter_invalid_email_id_password_and_click_on_Login_butotn() throws Throwable {
