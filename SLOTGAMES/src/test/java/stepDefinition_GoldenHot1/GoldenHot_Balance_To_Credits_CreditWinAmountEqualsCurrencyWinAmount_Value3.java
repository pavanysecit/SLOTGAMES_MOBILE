...
public class GoldenHot_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value3 {
AppiumDriver<MobileElement> driver;
	
	public GoldenHot_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value3() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_godlen_hot_slot_game_balance_spin_button_win_amount_in_currency_credits_and_win_amount_in_credits_for_denomination_drop_down_value_three() throws Throwable {
	...
	public void open_the_Golded_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_select_the_dinomination_drop_down_value_three_click_on_spin_button_till_player_wins_click_on_balance_check_the_win_amount_and_click_on_balance() throws Throwable {
		...
		for(MobileElement me5:balance){
			//System.out.println(me2.getId()+"  "+me2.getText());
			if(me5.getId().equals("34")){
				Thread.sleep(1000);
				balBet = me5.getText();
			System.out.println("Win Amount after changing the denomination: " +me5.getText());
			Thread.sleep(2000);
			
			}			
		}
		double ww = dbi;
		if(balBet.endsWith("0"))
		{
		String pq="";
	    String paq=pq+ww;
		String bal="";
		String yui = paq.concat("0");
		System.out.println("Win Amount after concat: " +yui);
		Assert.assertEquals(balBet, yui);
		}
		else
		{
	
		Assert.assertEquals(balBet, dbi);
		}
	}

	@Then("^Win amount in credit multiplied by denomination drop down value three is equal to win amount in currency$")
	public void win_amount_in_credit_multiplied_by_denomination_drop_down_value_three_is_equal_to_win_amount_in_currency() throws Throwable {
	   Thread.sleep(2000);
	   driver.quit();
	}
}
