...
public class GoldenHot_Balance_Deduction_AccordingToBetType1_2 {
	...
	@Given("^Chrome browser, valid URL, valid login details, Golden Hot slot game, bet type as (\\d+)\\.(\\d+), bet value as (\\d+)\\.(\\d+), balance and spin button & win amount$")
	public void chrome_browser_valid_URL_valid_login_details_Golden_Hot_slot_game_bet_type_as_bet_value_as_balance_and_spin_button_win_amount(int arg1, int arg2, int arg3, int arg4) throws Throwable {
