...
public class GoldenHot_Gamble_GambleCount_For_BetType_2_And_Denomination_1 {
AppiumDriver<MobileElement> driver;
	
	public GoldenHot_Gamble_GambleCount_For_BetType_2_And_Denomination_1() throws InterruptedException {
	...
	@Then("^Gamble count should be displayed based on win amount and gamble max amount configured on the info page for bet type (\\d+)\\.(\\d+) & denomination (\\d+)\\.(\\d+)$")
	public void gamble_count_should_be_displayed_based_on_win_amount_and_gamble_max_amount_configured_on_the_info_page_for_bet_type_denomination(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		driver.quit();
	}
}
