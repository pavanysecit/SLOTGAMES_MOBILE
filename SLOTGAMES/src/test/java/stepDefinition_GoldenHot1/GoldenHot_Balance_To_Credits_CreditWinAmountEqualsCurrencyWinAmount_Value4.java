...
public class GoldenHot_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value4 {
AppiumDriver<MobileElement> driver;
	
	public GoldenHot_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value4() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_godlen_hot_slot_game_balance_spin_button_win_amount_in_currency_credits_and_win_amount_in_credits_for_denomination_drop_down_value_four() throws Throwable {
		driver.findElement(By.xpath("/html/body/div[3]/div[1]/ui-view/section/section[1]/div/div/div[2]/div[3]/ul/li[6]/div[1]/div")).click();
		Thread.sleep(3000);
	...
	public void open_the_Golded_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_select_the_dinomination_drop_down_value_four_click_on_spin_button_till_player_wins_click_on_balance_check_the_win_amount_and_click_on_balance() throws Throwable {
		...
		String balBet="";
		for(MobileElement me8:balance){
			//System.out.println(me2.getId()+"  "+me2.getText());
			if(me8.getId().equals("34")){
				Thread.sleep(1000);
				balBet = me8.getText();
			System.out.println("Win Amount after changing the denomination: " +me8.getText());
			Thread.sleep(2000);
	...
	public void win_amount_in_credit_multiplied_by_denomination_drop_down_value_four_is_equal_to_win_amount_in_currency() throws Throwable {
	   Thread.sleep(2000);
	   driver.quit();
	}
}