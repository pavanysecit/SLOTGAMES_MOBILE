...
public class GoldenHot_Balance_Deduction_AccordingToBetType2_3 {
AppiumDriver<MobileElement> driver;
//private MobileElement pqr;

	public GoldenHot_Balance_Deduction_AccordingToBetType2_3() throws InterruptedException {
	...
	@When("^Open the Golded hot slot game by entering the valid URL in browser, enter the valid login details, select the bet type as (\\d+)\\.(\\d+), select the bet value to (\\d+)\\.(\\d+), click on spin button, check the win amount and check the balance$")
	public void open_the_Golded_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_select_the_bet_value_to_click_on_spin_button_check_the_win_amount_and_check_the_balance(int arg1, int arg2, int arg3, int arg4) throws Throwable {
	List<MobileElement> balance = driver.findElementsByClassName("android.view.View");
		...
		for(MobileElement be1:balance)
		{
			...
			Assert.assertTrue(expected.contentEquals("1.25"));	
