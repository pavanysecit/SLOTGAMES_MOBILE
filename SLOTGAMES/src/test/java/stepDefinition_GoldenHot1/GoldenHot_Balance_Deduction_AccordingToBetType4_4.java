...
public class GoldenHot_Balance_Deduction_AccordingToBetType4_4 {
AppiumDriver<MobileElement> driver;
//private MobileElement pqr;

	public GoldenHot_Balance_Deduction_AccordingToBetType4_4() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_golden_hot_slot_game_bet_type_as_ONE_bet_value_as_FIFTY_balance_and_spin_button() throws Throwable {
		driver.findElement(By.xpath("/html/body/div[3]/div[1]/ui-view/section/section[1]/div/div/div[2]/div[3]/ul/li[6]/div[1]/div")).click();
		Thread.sleep(5000);
		
		driver.findElement(By.id("transferInput")).sendKeys("65.53");
		Thread.sleep(2000);
	...
	public void open_the_Golded_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_ONE_bet_value_as_FIFTY_click_on_spin_button_and_check_the_balance() throws Throwable {
	List<MobileElement> balance = driver.findElementsByClassName("android.view.View");
		...
		for(MobileElement be1:balance)
		{
			...
			Assert.assertTrue(expected.contentEquals("50"));	
	...
	public void balance_should_get_deducted_by_FIFTY_as_bet_type_is_selected_as_ONE_in_golden_hot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
