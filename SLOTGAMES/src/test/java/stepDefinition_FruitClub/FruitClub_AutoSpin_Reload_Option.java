...
public class FruitClub_AutoSpin_Reload_Option {
	AppiumDriver<MobileElement> driver;

	public FruitClub_AutoSpin_Reload_Option() throws InterruptedException {
		this.driver = FruitClub_URL_Login.getDriver();
		//this.driver = FruitClub_URL_TryNow.getDriver();
	}
	
	@Given("^Chrome browser, valid URL, valid login details, Fruit Club slot game, balance, Autospin button, browser hamburger reload button valid session invalid error message\\.$")
	public void chrome_browser_valid_URL_valid_login_details_Fruit_Club_slot_game_balance_Autospin_button_browser_hamburger_reload_button_valid_session_invalid_error_message() throws Throwable {
	   
	}

	@When("^Open the Fruit Club slot game by entering the valid URL in browser, enter the valid login details, select autospin button, click on  hamburger menu and reload the game session\\.$")
	public void open_the_Fruit_Club_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_autospin_button_click_on_hamburger_menu_and_reload_the_game_session() throws Throwable {
	...
	@Then("^User should not able to resume to game and autospin should be terminated and informed with valid error message for session invalid in Fruit Club slot game$")
	public void user_should_not_able_to_resume_to_game_and_autospin_should_be_terminated_and_informed_with_valid_error_message_for_session_invalid_in_Fruit_Club_slot_game() throws Throwable {
	   Thread.sleep(2000);
	   driver.quit();
	}
}