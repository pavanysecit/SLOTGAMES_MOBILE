...
//		Thread.sleep(2000);
		...
		String actual1 = driver.findElement(By.id("hud_BetPopup12.5")).getText();
...
//		Thread.sleep(2000);
		...
		String actual2 = driver.findElement(By.id("hud_BetPopup25")).getText();
		String expected2 = "5";
		System.out.println("\n" +actual2);
...
//		Thread.sleep(2000);
		...
		String actual3 = driver.findElement(By.id("hud_BetPopup312.5")).getText();
...
//		Thread.sleep(2000);
		...
		String actual4 = driver.findElement(By.id("hud_BetPopup425")).getText();
		String expected4 = "25";
		System.out.println("\n" +actual4);
...
//		Thread.sleep(2000);
		...
		String actual5 = driver.findElement(By.id("hud_BetPopup550")).getText();
		String expected5 = "50";
		System.out.println("\n" +actual5);
