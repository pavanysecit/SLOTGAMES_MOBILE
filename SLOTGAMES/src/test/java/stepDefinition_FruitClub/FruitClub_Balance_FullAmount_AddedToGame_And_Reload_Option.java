...
public class FruitClub_Balance_FullAmount_AddedToGame_And_Reload_Option {
	AppiumDriver<MobileElement> driver;

	
	@Given("^Chrome browser, valid URL, valid login details, Fruit Club slot game, Full amount transfer from account to game\\.$")
	public void chrome_browser_valid_URL_valid_login_details_Fruit_Club_slot_game_Full_amount_transfer_from_account_to_game() throws Throwable {
	...
	@When("^Open the Fruit Club slot game by entering the valid URL in browser, enter the valid login details, select game and transfer full amount same amount has to reflect in game balance, play and reload the game$")
	public void open_the_Fruit_Club_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_game_and_transfer_full_amount_same_amount_has_to_reflect_in_game_balance_play_and_reload_the_game() throws Throwable {
...
//		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@name='Suribet"))); 
	...
	@Then("^Remaining balance should be transfered to main account balance in Fruit Club slot game$")
	public void remaining_balance_should_be_transfered_to_main_account_balance_in_Fruit_Club_slot_game() throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}