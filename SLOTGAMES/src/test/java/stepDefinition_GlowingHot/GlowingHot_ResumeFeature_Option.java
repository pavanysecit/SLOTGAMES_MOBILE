...
public class GlowingHot_ResumeFeature_Option {
	AppiumDriver<MobileElement> driver;

	public GlowingHot_ResumeFeature_Option() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Glowing_Hot_slot_slot_game_bet_type_denomination_balance_spin_button_Gamble_screen_new_browser_session() throws Throwable {
	...
	public void resume_feature_should_enabled_and_land_on_the_gamble_screen_of_Glowing_Hot_slot_game() throws Throwable {
		Thread.sleep(1000);
	}
	...
	public void on_resuming_to_gamble_screen_collect_the_amount_and_verify_with_main_balance_addition_and_win_meter_amount_same_as_gamble_amount_in_gamble_page_in_Glowing_Hot_slot_game() throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
