...
public class GlowingHot_PayOut_BetType_1_And_Denomination_1 {
	...
	@When("^Open the Glowing Hot slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on icon to open payout table, check payout amount on each symbol like wild & scatter, click on back button, select bet type as (\\d+)\\.(\\d+) & denomination value as (\\d+)\\.(\\d+) and check payout amount on mobile$")
	public void open_the_Glowing_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_icon_to_open_payout_table_check_payout_amount_on_each_symbol_like_wild_scatter_click_on_back_button_select_bet_type_as_denomination_value_as_and_check_payout_amount_on_mobile(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		...
		if(me.getId().equals("16")){
			...
			System.out.println("Max Payout Value of 5 77777 symbols for denomination 0.15 is : " +Fsymbol);
		...
		if(me.getId().equals("17")){
			...
			System.out.println("Max Payout Value of 5 7777 symbols for denomination 0.15 is : " +F1symbol);
		...
		if(me.getId().equals("18")){
			...
			System.out.println("Max Payout Value of 5 777 symbols for denomination 0.15 is : " +F2symbol);
		...
		if(me.getId().equals("19")){
			...
			System.out.println("Max Payout Value of 5 77 symbols for denomination 0.15 is : " +F3symbol);
		...
		if(me.getId().equals("20")){
			...
			System.out.println("Payout Value of 5 watermelon symbols for denomination 0.15 is : " +wmelon);
		...
		if(me.getId().equals("21")){
			...
			System.out.println("Payout Value of 4 watermelon symbols for denomination 0.15 is: " +wmelon1);
		...
		if(me.getId().equals("22")){
			...
			System.out.println("Payout Value of 3 watermelon symbols for denomination 0.15 is: " +wmelon2);
		...
		if(me.getId().equals("23")){
			...
			System.out.println("Payout Value of 5 grapes symbols for denomination 0.15 is: " +grape);
		...
		if(me.getId().equals("24")){
			...
			System.out.println("Payout Value of 4 grapes symbols for denomination 0.15 is: " +grape1);
		...
		if(me.getId().equals("25")){
			...
			System.out.println("Payout Value of 3 grapes symbols for denomination 0.15 is: " +grape2);
		...
		if(me.getId().equals("26")){
			...
			System.out.println("Payout Value of 5 Bell symbols for denomination 0.15 is: " +bell);
		...
		if(me.getId().equals("27")){
			...
			System.out.println("Payout Value of 4 Bell symbols for denomination 0.15 is: " +bell1);
		...
		if(me.getId().equals("28")){
			...
			String actual12 = "0.9 YSI";
			System.out.println("Payout Value of 3 Bell symbols for denomination 0.15 is: " +bell2);
		...
		if(me.getId().equals("29")){
			...
			System.out.println("Payout Value of 5 cherry symbols for denomination 0.15 is: " +cherry);
		...
		if(me.getId().equals("30")){
			...
			System.out.println("Payout Value of 4 cherry symbols for denomination 0.15 is: " +cherry1);
		...
		if(me.getId().equals("31")){
			...
			System.out.println("Payout Value of 3 cherry symbols for denomination 0.15 is: " +cherry2);
		...
		if(me.getId().equals("32")){
			...
			System.out.println("Payout Value of 5 orange symbols for denomination 0.15 is: " +orange);
		...
		if(me.getId().equals("33")){
			...
			System.out.println("Payout Value of 4 orange symbols for denomination 0.15 is: " +orange1);
		...
		if(me.getId().equals("34")){
			...
			System.out.println("Payout Value of 3 orange symbols for denomination 0.15 is: " +orange2);
		...
		if(me.getId().equals("35")){
			...
			String actual19 = "15 YSI";
			System.out.println("Payout Value of 5 scatter symbols for denomination 0.15 is: " +scatter);
		...
		if(me.getId().equals("36")){
			...
			System.out.println("Payout Value of 4 scatter symbols for denomination 0.15 is: " +scatter1);
		...
		if(me.getId().equals("37")){
			...
			String actual21 = "0.45 YSI";
			System.out.println("Payout Value of 3 scatter symbols for denomination 0.15 is: " +scatter2);
		...
		if(me.getId().equals("38")){
			...
			System.out.println("Payout Value of 3 purple scatter symbol for denomination 0.15 is: " +pscatter);
	...
	@Then("^System should display the Payout max amount on each symbol like wild & scatter and payout max amount should get changed whenever player changes the bet type to (\\d+)\\.(\\d+) and denomination value to (\\d+)\\.(\\d+) in Glowing Hot slot game on mobile$")
	public void system_should_display_the_Payout_max_amount_on_each_symbol_like_wild_scatter_and_payout_max_amount_should_get_changed_whenever_player_changes_the_bet_type_to_and_denomination_value_to_in_Glowing_Hot_slot_game_on_mobile(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
