...
public class GlowingHot_Balance_Credits_Calculations_Value4 {
	AppiumDriver<MobileElement> driver;

	public GlowingHot_Balance_Credits_Calculations_Value4() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Glowing_Hot_slot_game_balance_credits_and_denomination_drop_down_value_as_ONE() throws Throwable {
	...
	public void open_the_Glowing_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_balance_multiply_credit_by_denomination_ONE_manually_with_and_check_the_balance() throws Throwable {
	...
	public void balance_amount_should_be_same_after_multiplying_denomination_ONE_by_credit_in_Glowing_Hot_slot_game() throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
