...
public class GlowingHot_ResumeFeature_DisabledOption_WithoutWin {
	AppiumDriver<MobileElement> driver;

	public GlowingHot_ResumeFeature_DisabledOption_WithoutWin() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Glowing_Hot_slot_slot_game_bet_type_denomination_balance_spin_button_Gamble_screen_Gamble_collect() throws Throwable {
	...
	public void resume_feature_should_not_be_enabled_and_land_on_the_game_screen_of_Glowing_Hot_slot_game() throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}