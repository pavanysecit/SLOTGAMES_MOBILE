...
public class GlowingHot_Balance_Deduction_AccordingToBetType3_1 {
	AppiumDriver<MobileElement> driver;

	public GlowingHot_Balance_Deduction_AccordingToBetType3_1() throws InterruptedException {
	...
	@When("^Open the Glowing Hot slot game by entering the valid URL in browser, enter the valid login details, select the bet value as (\\d+)\\.(\\d+) from bet type drop down, click on spin button and check the balance$")
	public void open_the_Glowing_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_value_as_from_bet_type_drop_down_click_on_spin_button_and_check_the_balance(int arg1, int arg2) throws Throwable {
