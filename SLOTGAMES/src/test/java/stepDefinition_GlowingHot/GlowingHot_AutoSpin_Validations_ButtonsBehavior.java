...
public class GlowingHot_AutoSpin_Validations_ButtonsBehavior {
	AppiumDriver<MobileElement> driver;

	public GlowingHot_AutoSpin_Validations_ButtonsBehavior() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Glowing_Hot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_check_for_buttons_behavior_functionality() throws Throwable {
	...
	public void open_the_Glowing_Hot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_behavior_of_different_buttons_in_different_scenarios() throws Throwable {
	...
	public void bet_value_Credit_value_buttons_should_not_be_clickable_in_Glowing_Hot_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Home and Info buttons should not be clickable in Glowing Hot game$")
	public void home_and_Info_buttons_should_not_be_clickable_in_Glowing_Hot_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Spin button should not visible & Stop button should be visible and clickable in Glowing Hot game$")
	public void spin_button_should_not_visible_Stop_button_should_be_visible_and_clickable_in_Glowing_Hot_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Spin button should be visble after clicking on stop button in in Glowing Hot game$")
	public void spin_button_should_be_visble_after_clicking_on_stop_button_in_in_Glowing_Hot_game() throws Throwable {
		driver.quit();
	}
}
