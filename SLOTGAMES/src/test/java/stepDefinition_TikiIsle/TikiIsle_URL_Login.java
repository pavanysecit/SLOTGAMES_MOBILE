...
public class TikiIsle_URL_Login {
private static AppiumDriver<MobileElement> driver;
	
	//@Before
	public static void  TikiIsle_URL_Login() throws InterruptedException, MalformedURLException, FindFailed {
...
//		cap.setCapability("appActivity", "org.chromium.chrome.browser.ChromeTabbedActivity");
		...
		driver.findElement(By.xpath("/html/body/div[3]/div[1]/ui-view/section/section[1]/div/div/div[2]/div[3]/ul/li[6]/div[1]/div/span")).click();
		Thread.sleep(2000);
		...
		WebElement  login_button=  driver.findElement(By.xpath("/html/body/div[3]/div[1]/ui-view/section/section[1]/div/div/div[2]/div[3]/ul/li[6]/div[1]/div/span"));
