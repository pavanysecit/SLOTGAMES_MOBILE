...
public class FrizzlingHot_Check_BetType_BetValue_DropDown4 {
...
//		Thread.sleep(2000);
	...
	public void bet_value_should_get_changed_to_if_the_bet_type_selected_as_from_the_drop_down_three_in_Frizzling_Hot_slot_game(int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
