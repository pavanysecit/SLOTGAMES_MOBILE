...
public class FrizzlingHot_Gamble_WinAmount_SameAs_GambleAmount {
	AppiumDriver<MobileElement> driver;

	public FrizzlingHot_Gamble_WinAmount_SameAs_GambleAmount() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Frizzling_Hot_slot_game_balance_spin_button_win_amount_gamble_button_and_gamble_amount() throws Throwable {
	...
	public void open_the_Frizzling_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_amount() throws Throwable {
	...
	public void win_amount_should_be_displayed_as_Gamble_amount_in_the_gamble_page_of_the_Frizzling_Hot_slot_game() throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
