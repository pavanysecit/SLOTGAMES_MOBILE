...
public class FrizzlingHot_Check_UserInstruction_Messages {
	AppiumDriver<MobileElement> driver;

	public FrizzlingHot_Check_UserInstruction_Messages() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Frizzling_Hot_slot_game_balance_spin_button_and_user_instruction_message() throws Throwable {
	...
	public void open_the_Frizzling_Hot_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_and_check_the_user_instruction_messages() throws Throwable {
	...
	@Then("^User instruction message 'Good Luck' should be displayed after spin button is clicked in Frizzling Hot slot game$")
	public void user_instruction_message_Good_Luck_should_be_displayed_after_spin_button_is_clicked_in_Frizzling_Hot_slot_game() throws Throwable {
		driver.quit();
	}
}
