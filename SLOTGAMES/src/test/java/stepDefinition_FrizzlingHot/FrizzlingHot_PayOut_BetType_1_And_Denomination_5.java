...
public class FrizzlingHot_PayOut_BetType_1_And_Denomination_5 {
	AppiumDriver<MobileElement> driver;

	public FrizzlingHot_PayOut_BetType_1_And_Denomination_5() throws InterruptedException {
		this.driver = FrizzlingHot_URL_Login.getDriver();
		//this.driver = FrizzlingHot_URL_TryNow.getDriver();
		}
	
	@Given("^Chrome browser, valid URL, valid login details, Frizzling Hot slot game, icon to open payout table, all symbols, max amount on each symbol like grapes, plum & etc, back button, bet type (\\d+)\\.(\\d+) and denomination as (\\d+) on mobile$")
	public void chrome_browser_valid_URL_valid_login_details_Frizzling_Hot_slot_game_icon_to_open_payout_table_all_symbols_max_amount_on_each_symbol_like_grapes_plum_etc_back_button_bet_type_and_denomination_as_on_mobile(int arg1, int arg2, int arg3) throws Throwable {
	...
	@When("^Open the Frizzling Hot slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on icon to open payout table, check payout amount on each symbol like grapes, plum & etc, click on back button, select bet type as (\\d+)\\.(\\d+) & denomination as (\\d+) and check payout amount on mobile$")
	public void open_the_Frizzling_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_icon_to_open_payout_table_check_payout_amount_on_each_symbol_like_grapes_plum_etc_click_on_back_button_select_bet_type_as_denomination_as_and_check_payout_amount_on_mobile(int arg1, int arg2, int arg3) throws Throwable {
		...
		if(me.getId().equals("33")){
			...
			String actual8 = "240 YSI";
			System.out.println("Payout Value of 5 Watermelon symbol for denomination 2: " +Wmelon);
		...
		if(me.getId().equals("34")){
			...
			String actual9 = "120 YSI";
			System.out.println("Payout Value of 4 Watermelon symbol for denomination 2: " +Wmelon1);
		...
		if(me.getId().equals("35")){
			...
			System.out.println("Payout Value of 3 Watermelon symbol for denomination 2: " +Wmelon2);
		...
		if(me.getId().equals("39")){
			...
			String actual14 = "80 YSI";
			System.out.println("Payout Value of 5 Plum symbol for denomination 2 is: " +Plum);
		...
		if(me.getId().equals("40")){
			...
			String actual15 = "24 YSI";
			System.out.println("Payout Value of 4 Plum symbol for denomination 2 is: " +Plum1);
		...
		if(me.getId().equals("41")){
			...
			String actual16 = "8 YSI";
			System.out.println("Payout Value of 3 Plum symbol for denomination 2 is: " +Plum2);
		...
		if(me.getId().equals("42")){
			...
			String actual17 = "80 YSI";
			System.out.println("Payout Value of 5 Orange symbol for denomination 2 is: " +Orange);
		...
		if(me.getId().equals("43")){
			...
			String actual18 = "24 YSI";
			System.out.println("Payout Value of 4 Orange symbol for denomination 2 is: " +Orange1);
		...
		if(me.getId().equals("44")){
			...
			String actual19 = "8 YSI";
			System.out.println("Payout Value of 3 Orange symbol for denomination 2 is: " +Orange2);
		...
		if(me.getId().equals("45")){
			...
			System.out.println("Payout Value of 5 Mango symbol for denomination 2 is: " +Mango);
		...
		if(me.getId().equals("46")){
			...
			System.out.println("Payout Value of 4 Mango symbol for denomination 2 is: " +Mango1);
		...
		if(me.getId().equals("47")){
			...
			System.out.println("Payout Value of 3 Mango symbol for denomination 2 is: " +Mango2);
		...
		if(me.getId().equals("48")){
			...
			String actual23 = "80 YSI";
			System.out.println("Payout Value of 5 Cherry symbol for denomination 2 is: " +Cherry);
		...
		if(me.getId().equals("49")){
			...
			String actual24 = "24 YSI";
			System.out.println("Payout Value of 4 Cherry symbol for denomination 2 is: " +Cherry1);
		...
		if(me.getId().equals("50")){
			...
			String actual25 = "8 YSI";
			System.out.println("Payout Value of 3 Cherry symbol for denomination 2 is: " +Cherry2);
		...
		if(me.getId().equals("51")){
			...
			String actual26 = "2 YSI";
			System.out.println("Payout Value of 2 Cherry symbol for denomination 2 is: " +Cherry3);
	...
	@Then("^System should display the Payout max amount on each symbol like grapes, plum & etc and payout max amount should get changed whenever player changes the bet type to (\\d+)\\.(\\d+) and denomination to (\\d+) in Frizzling Hot slot game on mobile$")
	public void system_should_display_the_Payout_max_amount_on_each_symbol_like_grapes_plum_etc_and_payout_max_amount_should_get_changed_whenever_player_changes_the_bet_type_to_and_denomination_to_in_Frizzling_Hot_slot_game_on_mobile(int arg1, int arg2, int arg3) throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
