...
public class GoldenCrown_Balance_Deduction_AccordingToBetType3_4 {
AppiumDriver<MobileElement> driver;
	...
	@Then("^Balance should get deducted by TEN if bet type is selected as (\\d+)\\.(\\d+) & bet value as TEN in Golden Crown game$")
	public void balance_should_get_deducted_by_TEN_if_bet_type_is_selected_as_bet_value_as_TEN_in_Golden_Crown_game(int arg1, int arg2) throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
