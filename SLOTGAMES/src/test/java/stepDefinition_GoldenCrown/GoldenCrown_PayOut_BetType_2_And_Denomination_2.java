...
public class GoldenCrown_PayOut_BetType_2_And_Denomination_2 {
AppiumDriver<MobileElement> driver;

	public GoldenCrown_PayOut_BetType_2_And_Denomination_2() throws InterruptedException {
	...
	@Given("^Chrome browser, valid URL, valid login details, Golden Crown slot game, icon to open payout table, all symbols, max amount on each symbol like bell n etc, back button, bet type (\\d+)\\.(\\d+) and denomination value (\\d+)\\.(\\d+)$")
	public void chrome_browser_valid_URL_valid_login_details_Golden_Crown_slot_game_icon_to_open_payout_table_all_symbols_max_amount_on_each_symbol_like_bell_n_etc_back_button_bet_type_and_denomination_value(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		driver.findElement(By.xpath("/html/body/div[3]/div[1]/ui-view/section/section[1]/div/div/div[2]/div[3]/ul/li[18]/div[1]")).click();
		Thread.sleep(2000);
	...
	@When("^Open the Golden Crown slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on icon to open payout table, check payout amount on each symbol like bell, click on back button, select bet type as (\\d+)\\.(\\d+) & denomination  value (\\d+)\\.(\\d+) and check payout amount$")
	public void open_the_Golden_Crown_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_icon_to_open_payout_table_check_payout_amount_on_each_symbol_like_bell_click_on_back_button_select_bet_type_as_denomination_value_and_check_payout_amount(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		...
		if(me.getId().equals("27")){
			...
			String actual4 = "28 YSI";
			System.out.println("Payout Value of 5 watermelon symbols for denomination 0.8 is : " +wmelon);
		...
		if(me.getId().equals("28")){
			...
			String actual5 = "4.8 YSI";
			System.out.println("Payout Value of 4 watermelon symbols for denomination 0.8 is: " +wmelon1);
		...
		if(me.getId().equals("29")){
			...
			System.out.println("Payout Value of 3 watermelon symbols for denomination 0.8 is: " +wmelon2);
		...
		if(me.getId().equals("30")){
			...
			System.out.println("Payout Value of 5 lemons symbols for denomination 0.8 is: " +grape);
		...
		if(me.getId().equals("31")){
			...
			System.out.println("Payout Value of 4 lemons symbols for denomination 0.8 is: " +grape1);
		...
		if(me.getId().equals("32")){
			...
			System.out.println("Payout Value of 3 lemons symbols for denomination 0.8 is: " +grape2);
		...
		if(me.getId().equals("33")){
			...
			String actual10 = "28 YSI";
			System.out.println("Payout Value of 5 Grapes symbols for denomination 0.8 is: " +bell);
		...
		if(me.getId().equals("34")){
			...
			String actual11 = "4.8 YSI";
			System.out.println("Payout Value of 4 Grapes symbols for denomination 0.8 is: " +bell1);
		...
		if(me.getId().equals("35")){
			...
			System.out.println("Payout Value of 3 Grapes symbols for denomination 0.8 is: " +bell2);
		...
		if(me.getId().equals("36")){
			...
			System.out.println("Payout Value of 5 Bells symbols for denomination 0.8 is: " +cherry);
		...
		if(me.getId().equals("37")){
			...
			String actual14 = "1.6 YSI";
			System.out.println("Payout Value of 4 Bells symbols for denomination 0.8 is: " +cherry1);
		...
		if(me.getId().equals("38")){
			...
			System.out.println("Payout Value of 3 Bells symbols for denomination 0.8 is: " +cherry2);
		...
		if(me.getId().equals("39")){
			...
			System.out.println("Payout Value of 5 orange symbols for denomination 0.8 is: " +orange);
		...
		if(me.getId().equals("40")){
			...
			System.out.println("Payout Value of 4 orange symbols for denomination 0.8 is: " +orange1);
		...
		if(me.getId().equals("41")){
			...
			System.out.println("Payout Value of 3 orange symbols for denomination 0.8 is: " +orange2);
		...
		if(me.getId().equals("43")){
			...
			System.out.println("Payout Value of 4 scatter symbols for denomination 0.8 is: " +scatter1);
		...
		if(me.getId().equals("44")){
			...
			System.out.println("Payout Value of 3 scatter symbols for denomination 0.8 is: " +scatter2);
		...
		if(me.getId().equals("45")){
			...
			System.out.println("Payout Value of Star scatter symbol for denomination 0.8 is: " +pscatter);
	...
	@Then("^System should display the Payout max amount on each symbol like bell and payout max amount should get changed whenever player changes the bet type to (\\d+)\\.(\\d+) and denomination value (\\d+)\\.(\\d+) in Golden Crown slot game$")
	public void system_should_display_the_Payout_max_amount_on_each_symbol_like_bell_and_payout_max_amount_should_get_changed_whenever_player_changes_the_bet_type_to_and_denomination_value_in_Golden_Crown_slot_game(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		driver.quit();
	}
}
