...
public class GoldenCrown_Balance_Deduction_AccordingToBetType1_2 {
AppiumDriver<MobileElement> driver;

	public GoldenCrown_Balance_Deduction_AccordingToBetType1_2() throws InterruptedException {
	...
	public void balance_should_get_deducted_by_as_bet_type_is_selected_as_in_Golden_Crown_game(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		Thread.sleep(2000);
	    driver.quit(); 
	}
}
