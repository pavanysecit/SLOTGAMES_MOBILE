...
public class GoldenCrown_Gamble_GambleCount_For_BetType_1_And_Denomination_5 {
AppiumDriver<MobileElement> driver;

	public GoldenCrown_Gamble_GambleCount_For_BetType_1_And_Denomination_5() throws InterruptedException {
	...
	@Then("^Gamble count should be displayed based on win amount and gamble max amount configured on the game info page for bet type (\\d+)\\.(\\d+) & denomination FOUR in Golden Crown game$")
	public void gamble_count_should_be_displayed_based_on_win_amount_and_gamble_max_amount_configured_on_the_game_info_page_for_bet_type_denomination_FOUR_in_Golden_Crown_game(int arg1, int arg2) throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
