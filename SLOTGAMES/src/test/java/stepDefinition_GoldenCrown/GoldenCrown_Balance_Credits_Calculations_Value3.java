...
public class GoldenCrown_Balance_Credits_Calculations_Value3 {
AppiumDriver<MobileElement> driver;

	public GoldenCrown_Balance_Credits_Calculations_Value3() throws InterruptedException {
		this.driver = GoldenCrown_URL_Login.getDriver();
		
		}
	
	@Given("^Chrome browser, valid URL, valid login details, Golden Crown slot game window, balance, credits, denomination drop down and denomination as (\\d+)\\.(\\d+)$")
	public void chrome_browser_valid_URL_valid_login_details_Golden_Crown_slot_game_window_balance_credits_denomination_drop_down_and_denomination_as(int arg1, int arg2) throws Throwable {
	...
	public void balance_amound_should_be_same_as_denomination_multiplies_by_credit_balance_in_Golden_Crown_slot_game(int arg1, int arg2) throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
