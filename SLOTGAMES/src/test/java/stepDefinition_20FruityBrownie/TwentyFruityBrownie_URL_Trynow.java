...
public class TwentyFruityBrownie_URL_Trynow {
private static AppiumDriver<MobileElement> driver;
	
	//@Before
	public static void  TwentyFruityBrownie_URL_Trynow() throws InterruptedException, MalformedURLException, FindFailed {
