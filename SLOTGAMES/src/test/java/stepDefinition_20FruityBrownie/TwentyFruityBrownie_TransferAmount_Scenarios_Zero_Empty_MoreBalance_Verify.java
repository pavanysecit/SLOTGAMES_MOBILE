...
public class TwentyFruityBrownie_TransferAmount_Scenarios_Zero_Empty_MoreBalance_Verify {
	...
	@Given("^Chrome browser, valid URL, valid login details, (\\d+) Fruity Brownie game, balance, text field to transfer balance and Ok button$")
	public void chrome_browser_valid_URL_valid_login_details_Fruity_Brownie_game_balance_text_field_to_transfer_balance_and_Ok_button(int arg1) throws Throwable {
...
//        String formattedNumber = format.format(total);
	...
	public void the_exact_amount_entered_in_the_transfer_page_should_transfer_to_Fruity_Brownie_game_and_same_amount_should_get_displayed_on_the_balance_section(int arg1) throws Throwable {
