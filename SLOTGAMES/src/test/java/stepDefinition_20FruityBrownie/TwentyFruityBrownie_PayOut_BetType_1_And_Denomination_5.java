...
public class TwentyFruityBrownie_PayOut_BetType_1_And_Denomination_5 {
	AppiumDriver<MobileElement> driver;

	public TwentyFruityBrownie_PayOut_BetType_1_And_Denomination_5() throws InterruptedException {
		this.driver = TwentyFruityBrownie_URL_Login.getDriver();
		}
	
	@Given("^Chrome browser, valid URL, valid login details, (\\d+) Fruity Brownie slot game, icon to open payout table, all symbols, max amount on each symbol like watermelon, cherry n etc, back button, bet type (\\d+)\\.(\\d+) and denomination as (\\d+) on mobile$")
	public void chrome_browser_valid_URL_valid_login_details_Fruity_Brownie_slot_game_icon_to_open_payout_table_all_symbols_max_amount_on_each_symbol_like_watermelon_cherry_n_etc_back_button_bet_type_and_denomination_as_on_mobile(int arg1, int arg2, int arg3, int arg4) throws Throwable {
	...
	@When("^Open the (\\d+) Fruity Brownie slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on icon to open payout table, check payout amount on each symbol like watermelon, cherry n etc, click on back button, select bet type as (\\d+)\\.(\\d+) & denomination value as (\\d+) and check payout amount on mobile$")
	public void open_the_Fruity_Brownie_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_icon_to_open_payout_table_check_payout_amount_on_each_symbol_like_watermelon_cherry_n_etc_click_on_back_button_select_bet_type_as_denomination_value_as_and_check_payout_amount_on_mobile(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		...
		if(me.getId().equals("33")){
			...
			System.out.println("Payout Value of 5 Bell symbol for denomination 4: " +Bell);
		...
		if(me.getId().equals("34")){
			...
			System.out.println("Payout Value of 4 Bell symbol for denomination 4: " +Bell1);
		...
		if(me.getId().equals("35")){
			...
			System.out.println("Payout Value of 3 Bell symbol for denomination 4: " +Bell2);
		...
		if(me.getId().equals("36")){
			...
			System.out.println("Payout Value of 2 Bell symbol for denomination 4: " +Bell3);
			Assert.assertEquals(actual10, expected10);
			Thread.sleep(1000);
		}
		...
		if(me.getId().equals("37")){
			...
			String actual8 = "16 YSI";
			System.out.println("Payout Value of 5 Apple symbol for denomination 4: " +Apple);
			Assert.assertEquals(actual8, expected8);
			Thread.sleep(1000);
		}
		...
		if(me.getId().equals("38")){
			...
			System.out.println("Payout Value of 4 Apple symbol for denomination 4: " +Apple1);
			Assert.assertEquals(actual9, expected9);
			Thread.sleep(1000);
		}
		...
		if(me.getId().equals("39")){
			...
			String actual10 = "2 YSI";
			System.out.println("Payout Value of 3 Apple symbol for denomination 4: " +Apple2);
			Assert.assertEquals(actual10, expected10);
			Thread.sleep(1000);
		}
		...
		if(me.getId().equals("40")){
			...
			String actual10 = "1 YSI";
			System.out.println("Payout Value of 2 Apple symbol for denomination 4: " +Apple3);
			Assert.assertEquals(actual10, expected10);
			Thread.sleep(1000);
		}
		...
		if(me.getId().equals("41")){
			...
			System.out.println("Payout Value of 5 Banana or Watermelon symbol for denomination 4 is: " +wmelon);
		...
		if(me.getId().equals("42")){
			...
			System.out.println("Payout Value of 4 Banana or Watermelon symbol for denomination 4 is: " +wmelon1);
		...
		if(me.getId().equals("43")){
			...
			System.out.println("Payout Value of 3 Banana or Watermelon symbol for denomination 4 is: " +wmelon2);
		...
		if(me.getId().equals("44")){
			...
			System.out.println("Payout Value of 5 Banana symbol for denomination 4 is: " +banana);
			Assert.assertEquals(actual11, expected11);
			Thread.sleep(1000);
			} 
		...
		if(me.getId().equals("45")){
			...
			System.out.println("Payout Value of 4 Banana symbol for denomination 4 is: " +banana1);
			Assert.assertEquals(actual12, expected12);
			Thread.sleep(1000);
			}
		...
		if(me.getId().equals("46")){
			...
			String actual13 = "2 YSI";
			System.out.println("Payout Value of 3 Banana symbol for denomination 4 is: " +banana2);
			Assert.assertEquals(actual13, expected13);
			Thread.sleep(1000);
			}
		...
		if(me.getId().equals("50")){
			...
			System.out.println("Payout Value of 5 Plum or Orange symbol for denomination 4 is: " +op);
			Assert.assertEquals(actual14, expected14);
			Thread.sleep(1000);
			} 
		...
		if(me.getId().equals("51")){
			...
			System.out.println("Payout Value of 4 Plum or Orange symbol for denomination 4 is: " +op1);
			Assert.assertEquals(actual15, expected15);
			Thread.sleep(1000);
			}
		...
		if(me.getId().equals("52")){
			...
			String actual16 = "2 YSI";
			System.out.println("Payout Value of 3 Plum or Orange symbol for denomination 4 is: " +op2);
			Assert.assertEquals(actual16, expected16);
			Thread.sleep(1000);
			}
		...
		if(me.getId().equals("53")){
			...
			System.out.println("Payout Value of 5 Lemon or Cherry symbol for denomination 4 is: " +LC);
			Assert.assertEquals(actual14, expected14);
			Thread.sleep(1000);
			} 
		...
		if(me.getId().equals("54")){
			...
			System.out.println("Payout Value of 4 Lemon or Cherry symbol for denomination 4 is: " +LC1);
			Assert.assertEquals(actual15, expected15);
			Thread.sleep(1000);
			}
		...
		if(me.getId().equals("55")){
			...
			System.out.println("Payout Value of 3 Lemon or Cherry symbol for denomination 4 is: " +LC2);
			Assert.assertEquals(actual16, expected16);
			Thread.sleep(1000);
			}
		}
	...
	@Then("^System should display the Payout max amount on each symbol like watermelon, cherry n etc and payout max amount should get changed whenever player changes the bet type to (\\d+)\\.(\\d+) and denomination value to (\\d+) in (\\d+) Fruity Brownie slot game on mobile$")
	public void system_should_display_the_Payout_max_amount_on_each_symbol_like_watermelon_cherry_n_etc_and_payout_max_amount_should_get_changed_whenever_player_changes_the_bet_type_to_and_denomination_value_to_in_Fruity_Brownie_slot_game_on_mobile(int arg1, int arg2, int arg3, int arg4) throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
