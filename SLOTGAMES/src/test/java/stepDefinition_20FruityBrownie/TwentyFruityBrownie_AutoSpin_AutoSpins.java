...
public class TwentyFruityBrownie_AutoSpin_AutoSpins {
	AppiumDriver<MobileElement> driver;

	public TwentyFruityBrownie_AutoSpin_AutoSpins() throws InterruptedException {
		this.driver = TwentyFruityBrownie_URL_Login.getDriver();
		}
	
	@Given("^Chrome browser, valid URL, valid login details, (\\d+) Fruity Brownie slot game, balance, spin button, auto spin button, auto spins option and number of spins left message$")
	public void chrome_browser_valid_URL_valid_login_details_Fruity_Brownie_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_number_of_spins_left_message(int arg1) throws Throwable {
	...
	public void system_should_keep_performing_the_spins_in_Fruity_Brownie_slot_game(int arg1) throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
