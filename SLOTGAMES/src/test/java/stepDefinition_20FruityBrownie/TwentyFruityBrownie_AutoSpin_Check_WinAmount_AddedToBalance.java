...
public class TwentyFruityBrownie_AutoSpin_Check_WinAmount_AddedToBalance {
	AppiumDriver<MobileElement> driver;

	public TwentyFruityBrownie_AutoSpin_Check_WinAmount_AddedToBalance() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Twenty_Fruity_Brownie_slot_game_balance_Autospin_button_win_amount_added_to_balance() throws Throwable {
	...
	public void open_the_Twenty_Fruity_Brownie_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_autospin_play_till_win_triggers_and_observe_win_amount_added_to_main_balance_in_next_spin_itteration() throws Throwable {
	...
	public void automatically_Win_amount_should_get_added_to_the_main_balance_after_win_and_balance_should_get_increased_with_win_amount_and_next_spin_should_continue_in_Twenty_Fruity_Brownie_slot_game() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
