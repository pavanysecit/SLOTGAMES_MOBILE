...
public class TwentyFruityBrownie_TryNow_Check_WinAmount_AddedToBalance {
	...
	@Given("^Chrome browser, valid URL, valid login details, (\\d+) Fruity Brownie slot game, try now button, balance to play, spin button and win amount$")
	public void chrome_browser_valid_URL_valid_login_details_Fruity_Brownie_slot_game_try_now_button_balance_to_play_spin_button_and_win_amount(int arg1) throws Throwable {
	...
	@When("^Open the (\\d+) Fruity Brownie slot game by entering the valid URL in browser, click on try now button, click on spin button till player win and check the balance after win$")
	public void open_the_Fruity_Brownie_slot_game_by_entering_the_valid_URL_in_browser_click_on_try_now_button_click_on_spin_button_till_player_win_and_check_the_balance_after_win(int arg1) throws Throwable {
