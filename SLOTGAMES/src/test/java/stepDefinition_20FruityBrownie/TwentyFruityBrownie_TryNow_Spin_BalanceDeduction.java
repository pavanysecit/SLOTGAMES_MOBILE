...
public class TwentyFruityBrownie_TryNow_Spin_BalanceDeduction {
	...
	@Given("^Chrome browser, valid URL, valid login details, (\\d+) Fruity Brownie slot game, try now button, balance to play and spin button$")
	public void chrome_browser_valid_URL_valid_login_details_Fruity_Brownie_slot_game_try_now_button_balance_to_play_and_spin_button(int arg1) throws Throwable {
	...
	@When("^Open the (\\d+) Fruity Brownie slot game by entering the valid URL in browser, click on try now button and click on spin button$")
	public void open_the_Fruity_Brownie_slot_game_by_entering_the_valid_URL_in_browser_click_on_try_now_button_and_click_on_spin_button(int arg1) throws Throwable {
