...
public class TwentyFruityBrownie_AutoSpin_Validations_GamblePage {
	AppiumDriver<MobileElement> driver;

	public TwentyFruityBrownie_AutoSpin_Validations_GamblePage() throws InterruptedException {
	...
	public void open_the_Fruity_Brownie_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_behavior_of_different_buttons_after_navigating_from_gamble_page_to_game_page(int arg1) throws Throwable {
		WebDriverWait wait1 = new WebDriverWait(driver, 80);
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("hud_Hud_txtBalance1"))); 
