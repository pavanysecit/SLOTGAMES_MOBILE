...
public class TwentyFruityBrownie_Balance_Deduction_AccordingToBetType1_3 {
	AppiumDriver<MobileElement> driver;

	public TwentyFruityBrownie_Balance_Deduction_AccordingToBetType1_3() throws InterruptedException {
		this.driver = TwentyFruityBrownie_URL_Login.getDriver();
		//this.driver = TwentyFruityBrownie_URL_TryNow.getDriver();
	}
	
	@Given("^Chrome browser, valid URL, valid login details, (\\d+) Fruity Brownie game, bet type as (\\d+)\\.(\\d+), bet value as ONE, balance and spin button$")
	public void chrome_browser_valid_URL_valid_login_details_Fruity_Brownie_game_bet_type_as_bet_value_as_ONE_balance_and_spin_button(int arg1, int arg2, int arg3) throws Throwable {
	...
	public void balance_should_get_deducted_by_ONE_as_bet_type_is_selected_as_in_Fruity_Brownie_game(int arg1, int arg2, int arg3) throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
