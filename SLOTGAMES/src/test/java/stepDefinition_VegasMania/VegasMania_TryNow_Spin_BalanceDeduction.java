...
public class VegasMania_TryNow_Spin_BalanceDeduction {
	...
	public void amount_should_get_deducted_from_balance_on_click_on_spin_button_in_try_now_page_of_Vegas_Maniaslot_game() throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
