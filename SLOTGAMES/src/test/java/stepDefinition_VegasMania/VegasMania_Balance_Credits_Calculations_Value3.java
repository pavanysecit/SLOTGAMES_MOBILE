...
public class VegasMania_Balance_Credits_Calculations_Value3 {
	AppiumDriver<MobileElement> driver;

	public VegasMania_Balance_Credits_Calculations_Value3() throws InterruptedException {
	...
	@Then("^Balance amound should be same as denomination (\\d+)\\.(\\d+) multiplies by credit balance in Vegas Mania slot game$")
	public void balance_amound_should_be_same_as_denomination_multiplies_by_credit_balance_in_Vegas_Mania_slot_game(int arg1, int arg2) throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
