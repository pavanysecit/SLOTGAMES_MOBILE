...
public class VegasMania_PayOut_BetType_1_And_Denomination_2 {
	AppiumDriver<MobileElement> driver;

	public VegasMania_PayOut_BetType_1_And_Denomination_2() throws InterruptedException {
		this.driver = VegasMania_URL_Login.getDriver();
		}
	
	@Given("^Chrome browser, valid URL, valid login details, Vegas Mania slot game, icon to open payout table, all symbols, max amount on each symbol, back button, bet type (\\d+)\\.(\\d+) and  denomination value as (\\d+)\\.(\\d+)$")
	public void chrome_browser_valid_URL_valid_login_details_Vegas_Mania_slot_game_icon_to_open_payout_table_all_symbols_max_amount_on_each_symbol_back_button_bet_type_and_denomination_value_as(int arg1, int arg2, int arg3, int arg4) throws Throwable {
	...
	public void open_the_Vegas_Mania_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_icon_to_open_payout_table_check_payout_amount_on_each_symbol_click_on_back_button_select_bet_type_as_denomination_values_as_and_check_payout_amount(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		...
		if(me.getId().equals("27")){
			...
			System.out.println("Max Payout Value of 777 symbols for denomination 0.2 is : " +F1symbol);
		...
		if(me.getId().equals("28")){
			...
			System.out.println("Max Payout Value of 77 symbols for denomination 0.2 is : " +F2symbol);
		...
		if(me.getId().equals("29")){
			...
			System.out.println("Max Payout Value of 7 symbols for denomination 0.2 is : " +F3symbol);
		...
		if(me.getId().equals("30")){
			...
			System.out.println("Payout Value of 5 ThreeBars symbols for denomination 0.2 is : " +ThreeBars);
		...
		if(me.getId().equals("31")){
			...
			System.out.println("Payout Value of 4 ThreeBars symbols for denomination 0.2 is: " +ThreeBars1);
		...
		if(me.getId().equals("32")){
			...
			System.out.println("Payout Value of 3 ThreeBars symbols for denomination 0.2 is: " +ThreeBars2);
		...
		if(me.getId().equals("33")){
			...
			System.out.println("Payout Value of 5 lemons symbols for denomination 0.2 is: " +wmelon);
		...
		if(me.getId().equals("34")){
			...
			System.out.println("Payout Value of 4 lemons symbols for denomination 0.2 is: " +wmelon1);
		...
		if(me.getId().equals("35")){
			...
			System.out.println("Payout Value of 3 lemons symbols for denomination 0.2 is: " +wmelon2);
		...
		if(me.getId().equals("36")){
			...
			System.out.println("Payout Value of 5 TwoBars symbols for denomination 0.2 is: " +TwoBars1);
		...
		if(me.getId().equals("37")){
			...
			System.out.println("Payout Value of 4 TwoBars symbols for denomination 0.2 is: " +TwoBars1);
		...
		if(me.getId().equals("38")){
			...
			System.out.println("Payout Value of 3 TwoBars symbols for denomination 0.2 is: " +TwoBars2);
		...
		if(me.getId().equals("39")){
			...
			System.out.println("Payout Value of 5 Bells symbols for denomination 0.2 is: " +SingleBar);
		...
		if(me.getId().equals("40")){
			...
			System.out.println("Payout Value of 4 SingleBar symbols for denomination 0.2 is: " +SingleBar1);
		...
		if(me.getId().equals("41")){
			...
			System.out.println("Payout Value of 3 SingleBar symbols for denomination 0.2 is: " +SingleBar2);
		...
		if(me.getId().equals("45")){
			...
			System.out.println("Payout Value of 5 Lemon symbols for denomination 0.2 is: " +Lemon);
		...
		if(me.getId().equals("46")){
			...
			String actual20 = "0.4 YSI";
			System.out.println("Payout Value of 4 Lemon symbols for denomination 0.2 is: " +Lemon1);
		...
		if(me.getId().equals("47")){
			...
			System.out.println("Payout Value of 3 Lemon symbols for denomination 0.2 is: " +Lemon2);
	...
	@Then("^System should display the Payout max amount on each symbol and payout max amount should get changed whenever player changes the bet type to (\\d+)\\.(\\d+) and denomination value as (\\d+)\\.(\\d+) in Vegas Mania slot game on mobile$")
	public void system_should_display_the_Payout_max_amount_on_each_symbol_and_payout_max_amount_should_get_changed_whenever_player_changes_the_bet_type_to_and_denomination_value_as_in_Vegas_Mania_slot_game_on_mobile(int arg1, int arg2, int arg3, int arg4) throws Throwable {
	    Thread.sleep(2000);
		driver.quit();
	}
}
