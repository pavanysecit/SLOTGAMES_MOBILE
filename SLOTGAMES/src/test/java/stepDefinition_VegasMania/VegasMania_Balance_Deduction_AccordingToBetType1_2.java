...
public class VegasMania_Balance_Deduction_AccordingToBetType1_2 {
	AppiumDriver<MobileElement> driver;

	public VegasMania_Balance_Deduction_AccordingToBetType1_2() throws InterruptedException {
	...
	@When("^Open the Vegas Mania slot game by entering the valid URL in browser, login to the website with valid login details, select the bet type as (\\d+)\\.(\\d+), click on spin button and check the balance$")
	public void open_the_Vegas_Mania_slot_game_by_entering_the_valid_URL_in_browser_login_to_the_website_with_valid_login_details_select_the_bet_type_as_click_on_spin_button_and_check_the_balance(int arg1, int arg2) throws Throwable {
