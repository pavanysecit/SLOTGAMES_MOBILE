...
public class TwentyGlowingHot_Check_UserInstruction_Messages {
	AppiumDriver<MobileElement> driver;

	public TwentyGlowingHot_Check_UserInstruction_Messages() throws InterruptedException {
	...
	public void open_the_Glowing_Hot_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_and_check_the_user_instruction_messages(int arg1) throws Throwable {
	...
	@Then("^User instruction message 'Good Luck' should be displayed after spin button is clicked in (\\d+) Glowing Hot slot game$")
	public void user_instruction_message_Good_Luck_should_be_displayed_after_spin_button_is_clicked_in_Glowing_Hot_slot_game(int arg1) throws Throwable {
		driver.quit();
	}
}
