...
public class FourtyGlowingHot_Transfer_Validation_AvailableBalance {
AppiumDriver<MobileElement> driver;
	
	public FourtyGlowingHot_Transfer_Validation_AvailableBalance() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_fourty_glowing_hot_game_balance_greater_than_available_balance_text_field_to_transfer_balance_Ok_button_and_validation_message() throws Throwable {
		driver.findElement(By.xpath("/html/body/div[3]/div[1]/ui-view/section/section[1]/div/div/div[2]/div[3]/ul/li[1]/div[1]/div/span")).click();
		Thread.sleep(5000);
	...
	public void open_the_fourty_glowing_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_enter_the_amount_greater_than_available_balance_and_click_on_Ok_butotn() throws Throwable {
	...
	public void player_should_be_blocked_from_loading_the_fourty_glowing_hot_game_when_the_amount_entered_in_the_transfer_page_is_more_than_the_available_balance() throws Throwable {
