...
public class FourtyGlowingHot_Gamble_WinAmount_AddedTo_Balance {
AppiumDriver<MobileElement> driver;
	
	public FourtyGlowingHot_Gamble_WinAmount_AddedTo_Balance() throws InterruptedException {
	...
	@When("^Open the (\\d+) glowing hot slot game by entering the valid URL in browser, enter the valid login details, click on (\\d+) glowing hotslot game, click on spin button till player wins, click on gamble button, click on red or black button and check the balance after win$")
	public void open_the_glowing_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_glowing_hotslot_game_click_on_spin_button_till_player_wins_click_on_gamble_button_click_on_red_or_black_button_and_check_the_balance_after_win(int arg1, int arg2) throws Throwable {
