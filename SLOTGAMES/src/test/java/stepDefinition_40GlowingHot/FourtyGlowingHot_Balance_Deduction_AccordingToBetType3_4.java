...
public class FourtyGlowingHot_Balance_Deduction_AccordingToBetType3_4 {
AppiumDriver<MobileElement> driver;
	
	public FourtyGlowingHot_Balance_Deduction_AccordingToBetType3_4() throws InterruptedException {
	...
	@Given("^Chrome browser, valid URL, valid login details, glowing hot slot game, bet type as (\\d+)\\.(\\d+) from drop down, bet value as twelve, balance and spin button$")
	public void chrome_browser_valid_URL_valid_login_details_glowing_hot_slot_game_bet_type_as_from_drop_down_bet_value_as_twelve_balance_and_spin_button(int arg1, int arg2) throws Throwable {
	    driver.findElement(By.xpath("/html/body/div[3]/div[1]/ui-view/section/section[1]/div/div/div[2]/div[3]/ul/li[1]/div[1]/div/span")).click();
		Thread.sleep(5000);
	...
	public void open_the_Glowing_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_twelve_from_bet_type_drop_down_click_on_spin_button_and_check_the_balance() throws Throwable {
	List<MobileElement> balance = driver.findElementsByClassName("android.view.View");
		...
		System.out.println("Final Balance amount after deducting bet value 12 is: "+dbi);
		
		Assert.assertEquals(dbi,postspin);
	}


	@Then("^Balance should get deducted by twelve if bet type is selected as (\\d+)\\.(\\d+) & bet value as (\\d+) in glowing hot game$")
	public void balance_should_get_deducted_by_twelve_if_bet_type_is_selected_as_bet_value_as_in_glowing_hot_game(int arg1, int arg2, int arg3) throws Throwable {
		Thread.sleep(3000);
	    driver.quit();
	}
}
