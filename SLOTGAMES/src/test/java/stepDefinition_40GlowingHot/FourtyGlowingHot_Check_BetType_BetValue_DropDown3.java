...
public class FourtyGlowingHot_Check_BetType_BetValue_DropDown3 {
AppiumDriver<MobileElement> driver;
	
	public FourtyGlowingHot_Check_BetType_BetValue_DropDown3() throws InterruptedException {
	...
	public void open_the_glowing_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_from_drop_down_and_check_the_bet_value_should_be(int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) throws Throwable {
		...
		for(MobileElement me1:BetValue)
		{
			...
			Assert.assertTrue(actual1.contentEquals("0.2"));
			}
		...
		//Checking bet denomination should be 8, 16, 40, 80 and 160 if the bet value is selected as 0.2
		//Checking bet denomination drop down should have value 8 if the bet value is 0.2
		...
		//Checking denomination drop down should have value 16 if the bet value is 0.2
		if(me1.getId().equals("45"))
			...
			//Checking denomination drop down should have value 40 if the bet value is 0.2
		...
		if(me1.getId().equals("48"))
			...
			//Checking denomination drop down should have value 80 if the bet value is 0.2
		...
		if(me1.getId().equals("51"))
			...
			//Checking denomination drop down should have value 160 if the bet value is 0.2
