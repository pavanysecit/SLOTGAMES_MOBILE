...
public class FourtyGlowingHot_TransferAmount_Verify {
AppiumDriver<MobileElement> driver;
	
	public FourtyGlowingHot_TransferAmount_Verify() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_fourty_glowing_hot_game_balance_text_field_to_transfer_balance_and_Ok_button() throws Throwable {
		driver.findElement(By.xpath("/html/body/div[3]/div[1]/ui-view/section/section[1]/div/div/div[2]/div[3]/ul/li[1]/div[1]/div/span")).click();
		Thread.sleep(5000);
	...
	public void open_the_fourty_glowing_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_Play_button_enter_the_valid_amount_to_transfer_and_click_on_Ok_butotn() throws Throwable {
	...
	public void the_exact_amount_entered_in_the_transfer_page_should_transfer_to_fourty_glowing_hot_game_and_same_amount_should_get_displayed_on_the_balance_section() throws Throwable {
	    driver.quit();
	}
}