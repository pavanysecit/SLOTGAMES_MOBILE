...
public class FourtyGlowingHot_PayOut_BetType_1_And_Denomination_1 {
AppiumDriver<MobileElement> driver;
	...
	public void open_the_Glowing_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_click_on_icon_to_open_payout_table_check_payout_amount_on_each_symbol_click_on_back_button_select_bet_type_as_denomination_value_and_check_payout_amount(int arg1, int arg2, int arg3, int arg4, int arg5) throws Throwable {
		...
		if(me.getId().equals("18")){
			...
			System.out.println("Max Payout Value of 4 7777 symbols for denomination 0.4 is : " +F1symbol);
		...
		if(me.getId().equals("19")){
			...
			System.out.println("Max Payout Value of 3 777 symbols for denomination 0.4 is : " +F2symbol);
		...
		if(me.getId().equals("20")){
			...
			System.out.println("Max Payout Value of 2 77 symbols for denomination 0.4 is : " +F3symbol);
		...
		if(me.getId().equals("39")){
			...
			System.out.println("Payout Value of purple scatter symbol for denomination 0.4 is: " +pscatter);
			Assert.assertEquals(actual22, expected22);
			Thread.sleep(1000);
			}
		}
	...
	@Then("^System should display the Payout max amount on each symbol and payout max amount should get changed whenever player changes the bet type to (\\d+)\\.(\\d+) and denomination value (\\d+)\\.(\\d+) in (\\d+) glowing hot slot game$")
	public void system_should_display_the_Payout_max_amount_on_each_symbol_and_payout_max_amount_should_get_changed_whenever_player_changes_the_bet_type_to_and_denomination_value_in_glowing_hot_slot_game(int arg1, int arg2, int arg3, int arg4, int arg5) throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}