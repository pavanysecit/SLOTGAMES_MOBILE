...
public class FourtyGlowingHot_Balance_Credits_Calculations_Value3 {
AppiumDriver<MobileElement> driver;
	
	public FourtyGlowingHot_Balance_Credits_Calculations_Value3() throws InterruptedException {
	...
	List<MobileElement> balance = driver.findElementsByClassName("android.view.View");
		...
		//Selecting denomination as 0.03
