...
AppiumDriver<MobileElement> driver;
	...
	@Given("^Chrome browser, valid URL, valid login details, (\\d+) Glowing Hot slot game, balance, spin button and validation message, button behavior,$")
	public void chrome_browser_valid_URL_valid_login_details_Glowing_Hot_slot_game_balance_spin_button_and_validation_message_button_behavior(int arg1) throws Throwable {
	...
	@When("^Open the (\\d+) Glowing Hot slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on spin button till balance turns to zero and check the validation message with buttons behavior$")
	public void open_the_Glowing_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_till_balance_turns_to_zero_and_check_the_validation_message_with_buttons_behavior(int arg1) throws Throwable {
	...
	@Then("^Player should be blocked from playing the game when there is no balance in the account and buttons are inactive state in (\\d+) Glowing Hot game$")
	public void player_should_be_blocked_from_playing_the_game_when_there_is_no_balance_in_the_account_and_buttons_are_inactive_state_in_Glowing_Hot_game(int arg1) throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
