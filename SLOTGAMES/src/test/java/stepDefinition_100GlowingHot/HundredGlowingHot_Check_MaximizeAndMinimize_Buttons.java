...
public class HundredGlowingHot_Check_MaximizeAndMinimize_Buttons {
	AppiumDriver<MobileElement> driver;

	public HundredGlowingHot_Check_MaximizeAndMinimize_Buttons() throws InterruptedException {
	...
	@Then("^Full screen should be displayed after clicking on maximize button and minimized screen should be displayed after clicking on minimize button in (\\d+) Glowing Hot slot game$")
	public void full_screen_should_be_displayed_after_clicking_on_maximize_button_and_minimized_screen_should_be_displayed_after_clicking_on_minimize_button_in_Glowing_Hot_slot_game(int arg1) throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
