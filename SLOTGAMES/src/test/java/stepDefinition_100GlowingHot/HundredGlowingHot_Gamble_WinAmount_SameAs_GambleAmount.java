...
public class HundredGlowingHot_Gamble_WinAmount_SameAs_GambleAmount {
	AppiumDriver<MobileElement> driver;

	public HundredGlowingHot_Gamble_WinAmount_SameAs_GambleAmount() throws InterruptedException {
	...
	@When("^Open the (\\d+) Glowing Hot slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on spin button till player wins, click on gamble button and check the gamble amount$")
	public void open_the_Glowing_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_amount(int arg1) throws Throwable {
	...
	@Then("^Win amount should be displayed as Gamble amount in the gamble page of the (\\d+) Glowing Hot slot game$")
	public void win_amount_should_be_displayed_as_Gamble_amount_in_the_gamble_page_of_the_Glowing_Hot_slot_game(int arg1) throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
