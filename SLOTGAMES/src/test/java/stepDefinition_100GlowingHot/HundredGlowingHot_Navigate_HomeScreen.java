...
public class HundredGlowingHot_Navigate_HomeScreen {
	AppiumDriver<MobileElement> driver;

	public HundredGlowingHot_Navigate_HomeScreen() throws InterruptedException {
	...
	@When("^Open the (\\d+) Glowing Hot slot game by entering the valid URL in browser, enter the valid login details, transfer the balance and click on home button$")
	public void open_the_Glowing_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_and_click_on_home_button(int arg1) throws Throwable {
