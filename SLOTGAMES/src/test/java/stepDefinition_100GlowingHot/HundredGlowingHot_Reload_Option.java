...
public class HundredGlowingHot_Reload_Option {
	AppiumDriver<MobileElement> driver;

	public HundredGlowingHot_Reload_Option() throws InterruptedException {
	...
	public void user_should_not_able_to_resume_to_game_and_informed_with_valid_error_message_for_session_invalid_error_message_in_Hundred_Glowing_Hot_slot_game() throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
