...
public class HundredGlowingHot_Gamble_WinAmount_AddedTo_Balance {
	...
	@Given("^Chrome browser, valid URL, valid login details, Hundred Glowing Hot slot game, balance, spin button, win amount, gamble button, gamble amount, red button, black button and gamble status$")
	...
	@When("^Open the Hundred Glowing Hot slot game by entering the valid URL in browser, enter the valid login details, click on spin button till player wins, click on gamble button, click on red or black button and check the balance after win$")
	...
	@Then("^Gamble Win amount should get added to main balance after status displayed as WIN and gamble page should get closed in Hundred Glowing Hot slot game$")
