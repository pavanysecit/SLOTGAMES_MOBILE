...
public class HundredGlowingHot_Balance_Check_WinAmount_AddedToBalance_InCredits {
	AppiumDriver<MobileElement> driver;

	public HundredGlowingHot_Balance_Check_WinAmount_AddedToBalance_InCredits() throws InterruptedException {
	...
	@Then("^Win amount should get added to the balance in credit field after win and credit amount should get increased with win amount$")
	public void win_amount_should_get_added_to_the_balance_in_credit_field_after_win_and_credit_amount_should_get_increased_with_win_amount() throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}