...
public class TwentyFrizzlingHot_URL_TryNow {
private static AppiumDriver<MobileElement> driver;
	
	//@Before
	public static void  TwentyFrizzlingHot_URL_TryNow() throws InterruptedException, MalformedURLException, FindFailed {
