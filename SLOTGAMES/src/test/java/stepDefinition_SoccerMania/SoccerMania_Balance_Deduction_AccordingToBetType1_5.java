...
public class SoccerMania_Balance_Deduction_AccordingToBetType1_5 {
AppiumDriver<MobileElement> driver;

	public SoccerMania_Balance_Deduction_AccordingToBetType1_5() throws InterruptedException {
		this.driver = SoccerMania_URL_Login.getDriver();
		//this.driver = SoccerMania_URL_TryNow.getDriver();
	}
	
	@Given("^Chrome browser, valid URL, valid login details, Soccer Mania game, bet type as (\\d+)\\.(\\d+), bet value as SIX, balance and spin button$")
	public void chrome_browser_valid_URL_valid_login_details_Soccer_Mania_game_bet_type_as_bet_value_as_SIX_balance_and_spin_button(int arg1, int arg2) throws Throwable {
