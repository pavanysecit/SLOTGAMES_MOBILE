...
AppiumDriver<MobileElement> driver;
	...
	@Then("^Balance should get deducted by (\\d+)\\.(\\d+) after spin as bet type is selected as (\\d+)\\.(\\d+) and bet value as (\\d+)\\.(\\d+) in Soccer Mania game$")
	public void balance_should_get_deducted_by_after_spin_as_bet_type_is_selected_as_and_bet_value_as_in_Soccer_Mania_game(int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) throws Throwable {
	 	Thread.sleep(2000);
	    driver.quit();
	}
}
