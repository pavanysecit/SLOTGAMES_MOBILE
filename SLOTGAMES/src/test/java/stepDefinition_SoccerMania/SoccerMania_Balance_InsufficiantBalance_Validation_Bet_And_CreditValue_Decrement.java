...
public class SoccerMania_Balance_InsufficiantBalance_Validation_Bet_And_CreditValue_Decrement {
AppiumDriver<MobileElement> driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Soccer_Mania_slot_game_balance_counter_Auto_spin_button_validation_message_credit_types_and_bet_types() throws Throwable {
	...
	public void open_the_Soccer_Mania_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_Auto_spin_button_till_balance_counter_turns_less_than_betvalues_and_check_the_insufficient_validation_message_and_reduce_the_bet_and_credit_values_to_resume_the_play() throws Throwable {
		...
		driver.findElement(By.id("hud_txtBetAmount")).click();
		Thread.sleep(1000);
		MobileElement bet3_1= driver.findElement(By.id("hud_BetPopup11.5"));
		...
		driver.findElement(By.id("hud_txtBetAmount")).click();
		Thread.sleep(1000);
		MobileElement bet4_5_1= driver.findElement(By.id("hud_BetPopup5120"));
	...
	public void player_should_be_blocked_from_playing_the_game_when_there_is_less_amount_in_balance_counter_and_reducing_the_credit_and_bet_types_player_is_enable_to_continue_slot_game_in_Soccer_Mania_game() throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
