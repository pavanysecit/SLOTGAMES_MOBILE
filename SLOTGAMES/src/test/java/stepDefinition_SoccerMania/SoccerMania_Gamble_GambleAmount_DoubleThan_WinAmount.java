...
public class SoccerMania_Gamble_GambleAmount_DoubleThan_WinAmount {
	AppiumDriver<MobileElement> driver;

	public SoccerMania_Gamble_GambleAmount_DoubleThan_WinAmount() throws InterruptedException {
