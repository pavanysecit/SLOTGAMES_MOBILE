...
public class GummyLand_Balance_Deduction_AccordingToBetType4_2 {
	AppiumDriver<MobileElement> driver;

	public GummyLand_Balance_Deduction_AccordingToBetType4_2() throws InterruptedException {
		this.driver = GummyLand_URL_Login.getDriver();
		//this.driver = GummyLand_URL_TryNow.getDriver();
	}
	
	@Given("^Chrome browser, valid URL, valid login details, Gummy Land slot game, bet type as (\\d+)\\.(\\d+), bet value as TEN, balance and spin buttone$")
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_bet_type_as_bet_value_as_TEN_balance_and_spin_buttone(int arg1, int arg2) throws Throwable {
