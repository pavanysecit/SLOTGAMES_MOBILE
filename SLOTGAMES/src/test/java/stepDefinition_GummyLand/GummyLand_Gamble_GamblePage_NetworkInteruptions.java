...
public class GummyLand_Gamble_GamblePage_NetworkInteruptions {
	AppiumDriver<MobileElement> driver;

	public GummyLand_Gamble_GamblePage_NetworkInteruptions() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_balance_spin_button_gamble_screen_wifi_turnOFF_and_ON_network_messages() throws Throwable {
	...
	public void open_the_Gummy_Land_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_and_launch_the_game_spin_till_player_wins_selext_any_gamble_option_and_turn_OFF_wifi_and_check_for_valid_message_and_turn_on_wifi_for_gamble_to_resume_if_won_or_go_back_to_game_screen() throws Throwable {
	...
	public void user_is_addressed_with_valid_error_message_No_Internet_for_network_interuptions_in_gamble_page_of_Gummy_Land_slot_game() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
