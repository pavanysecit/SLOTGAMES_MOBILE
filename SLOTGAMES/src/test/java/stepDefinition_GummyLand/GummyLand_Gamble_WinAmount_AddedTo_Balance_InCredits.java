...
public class GummyLand_Gamble_WinAmount_AddedTo_Balance_InCredits {
	AppiumDriver<MobileElement> driver;

	public GummyLand_Gamble_WinAmount_AddedTo_Balance_InCredits() throws InterruptedException {
