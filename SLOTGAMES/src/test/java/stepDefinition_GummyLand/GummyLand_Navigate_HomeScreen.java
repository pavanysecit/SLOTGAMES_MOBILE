...
public class GummyLand_Navigate_HomeScreen {
	AppiumDriver<MobileElement> driver;

	public GummyLand_Navigate_HomeScreen() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_and_home_button() throws Throwable {
	...
	public void system_should_take_the_player_to_Home_page_after_clicking_on_home_button_from_Gummy_Land_game() throws Throwable {
	    Thread.sleep(1000);
	    driver.quit();
	}
}
