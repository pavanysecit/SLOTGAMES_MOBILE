...
public class FruityFortune_AutoSpin_AutoSpins {
	AppiumDriver<MobileElement> driver;

	public FruityFortune_AutoSpin_AutoSpins() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Fruity_Fortune_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_number_of_spins_left_message() throws Throwable {
	...
	public void open_the_Fruity_Fortune_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_the_player_instruction_message() throws Throwable {
	...
	public void system_should_keep_performing_the_spins_in_Fruity_Fortune_slot_game() throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}