...
public class FruityFortune_Check_MaximizeAndMinimize_Buttons {
	AppiumDriver<MobileElement> driver;

	public FruityFortune_Check_MaximizeAndMinimize_Buttons() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Fruity_Fortune_slot_game_maximize_button_and_minimize_button() throws Throwable {
	...
	public void open_the_Fruity_Fortune_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_maximize_button_and_click_on_minimize_button() throws Throwable {
	...
	public void full_screen_should_be_displayed_after_clicking_on_maximize_button_and_minimized_screen_should_be_displayed_after_clicking_on_minimize_button_in_Fruity_Fortune_slot_game() throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}