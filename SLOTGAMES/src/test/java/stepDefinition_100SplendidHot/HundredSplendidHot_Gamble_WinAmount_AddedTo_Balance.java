...
public class HundredSplendidHot_Gamble_WinAmount_AddedTo_Balance {
	AppiumDriver<MobileElement> driver;

	public HundredSplendidHot_Gamble_WinAmount_AddedTo_Balance() throws InterruptedException {
