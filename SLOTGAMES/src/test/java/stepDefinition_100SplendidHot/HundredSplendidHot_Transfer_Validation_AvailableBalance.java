...
public class HundredSplendidHot_Transfer_Validation_AvailableBalance {
	AppiumDriver<MobileElement> driver;

	public HundredSplendidHot_Transfer_Validation_AvailableBalance() throws InterruptedException {
		this.driver = HundredSplendidHot_URL_Login.getDriver();
		}
	
	@Given("^Chrome browser, valid URL, valid login details, (\\d+) Splendid Hot game, balance greater than available balance, text field to transfer balance, Ok button and validation message$")
	public void chrome_browser_valid_URL_valid_login_details_Splendid_Hot_game_balance_greater_than_available_balance_text_field_to_transfer_balance_Ok_button_and_validation_message(int arg1) throws Throwable {
