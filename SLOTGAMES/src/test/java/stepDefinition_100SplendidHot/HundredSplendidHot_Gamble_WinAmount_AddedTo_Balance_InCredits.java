...
public class HundredSplendidHot_Gamble_WinAmount_AddedTo_Balance_InCredits {
	AppiumDriver<MobileElement> driver;

	public HundredSplendidHot_Gamble_WinAmount_AddedTo_Balance_InCredits() throws InterruptedException {
