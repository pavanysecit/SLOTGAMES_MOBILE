...
public class HundredSplendidHot_ManualSpin_Validations_ButtonsBehavior {
	AppiumDriver<MobileElement> driver;

	public HundredSplendidHot_ManualSpin_Validations_ButtonsBehavior() throws InterruptedException {
	...
	public void bet_value_Credit_value_buttons_should_not_be_clickable_under_spin_condition_in_Hundred_Splendid_Hot_slot_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Home, Info and Turbo buttons should not be clickable on screen under spin condition in Hundred Splendid Hot slot game$")
	public void home_Info_and_Turbo_buttons_should_not_be_clickable_on_screen_under_spin_condition_in_Hundred_Splendid_Hot_slot_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Spin button should be disabled during reel spin in Hundred Splendid Hot slot game$")
	public void spin_button_should_be_disabled_during_reel_spin_in_Hundred_Splendid_Hot_slot_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Spin button should be visible after reel spin stops and if  win is triggered clicking on collect button in Hundred Splendid Hot slot game$")
	public void spin_button_should_be_visible_after_reel_spin_stops_and_if_win_is_triggered_clicking_on_collect_button_in_Hundred_Splendid_Hot_slot_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Gamble button behaviour under win triggered and disabled when next spin starts in Hundred Splendid Hot slot game$")
	public void gamble_button_behaviour_under_win_triggered_and_disabled_when_next_spin_starts_in_Hundred_Splendid_Hot_slot_game() throws Throwable {
	   driver.quit();
	}
}
