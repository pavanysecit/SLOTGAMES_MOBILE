...
public class HundredSplendidHot_Balance_InsufficiantBalance_Validation {
	...
	public void player_should_be_blocked_from_playing_the_game_when_there_is_no_balance_in_the_account_and_buttons_are_inactive_state_in_Hundred_Splendid_Hot_game() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
