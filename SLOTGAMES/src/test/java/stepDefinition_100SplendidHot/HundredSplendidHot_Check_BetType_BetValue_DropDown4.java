...
public class HundredSplendidHot_Check_BetType_BetValue_DropDown4 {
	AppiumDriver<MobileElement> driver;

	public HundredSplendidHot_Check_BetType_BetValue_DropDown4() throws InterruptedException {
...
//		Thread.sleep(2000);
		...
		String actual1 = driver.findElement(By.id("hud_BetPopup140")).getText();
		String expected1 = "40";
...
//		Thread.sleep(2000);
		...
		String actual2 = driver.findElement(By.id("hud_BetPopup280")).getText();
		String expected2 = "80";
		System.out.println("\n" +actual2);
...
//		Thread.sleep(2000);
		...
		String actual3 = driver.findElement(By.id("hud_BetPopup3120")).getText();
		String expected3 = "120";
		System.out.println("\n" +actual3);
...
//		Thread.sleep(2000);
		...
		String actual4 = driver.findElement(By.id("hud_BetPopup4160")).getText();
		String expected4 = "160";
		System.out.println("\n" +actual4);
