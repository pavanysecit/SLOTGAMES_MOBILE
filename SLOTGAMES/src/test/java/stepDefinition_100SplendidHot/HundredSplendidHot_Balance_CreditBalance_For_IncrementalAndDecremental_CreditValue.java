...
public class HundredSplendidHot_Balance_CreditBalance_For_IncrementalAndDecremental_CreditValue {
	AppiumDriver<MobileElement> driver;

	public HundredSplendidHot_Balance_CreditBalance_For_IncrementalAndDecremental_CreditValue() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Hundred_Splendid_Hot_slot_game_increment_decrement_and_balance_balance_in_credit_form_creditvalues() throws Throwable {
	...
	public void open_the_Hundred_Splendid_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_inc_and_dec_credit_balance_and_verify_the_balance_in_credit_form_and_verify_the_balance() throws Throwable {
		...
		System.out.println("testcase passed for creditvalue 0.01");
		System.out.println("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");

		//Incremental the credit from 0.01 to 0.06
		//Credit value 0.06
		creditValue.click();
		Thread.sleep(1000);
		...
		//Multiplying the credit by bet value 0.06 and comparing the balance
		...
		System.out.println("testcase passed for creditvalue 0.06");
		System.out.println("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
		
		//decrementing the credit from 0.06 to 0.04
		//Credit value 0.02
		creditValue.click();
		Thread.sleep(1000);
		MobileElement credit2 = driver.findElement(By.id("hud_CreditPopup20.04"));
		credit2.click();
		Thread.sleep(1000);
		String cred2 = creditValue.getText();
		Thread.sleep(1000);
		Assert.assertEquals("0.04",cred2);
		...
		System.out.println("testcase passed for creditvalue 0.04");
		System.out.println("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
	}
	...
	public void credit_balance_for_all_credit_values_should_be_same_as_balance_multiplies_by_credit_value_are_assigned_respectively_in_Hundred_Splendid_Hot_slot_game() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
