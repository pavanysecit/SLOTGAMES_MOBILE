...
public class CircusMania_TryNow_Check_WinAmount_AddedToBalance {
	...
	public void chrome_browser_valid_URL_valid_login_details_Circus_Mania_slot_game_try_now_button_balance_to_play_spin_button_and_win_amount() throws Throwable {
	...
	public void open_the_Circus_Mania_slot_game_by_entering_the_valid_URL_in_browser_click_on_try_now_button_click_on_spin_button_till_player_win_and_check_the_balance_after_win() throws Throwable {
	...
	@Then("^Win amount should get added to the balance when the player wins in try now page of Circus Mania slot gameThen System should keep performing the spins in Circus Mania slot game$")
	public void win_amount_should_get_added_to_the_balance_when_the_player_wins_in_try_now_page_of_Circus_Mania_slot_gameThen_System_should_keep_performing_the_spins_in_Circus_Mania_slot_game() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
