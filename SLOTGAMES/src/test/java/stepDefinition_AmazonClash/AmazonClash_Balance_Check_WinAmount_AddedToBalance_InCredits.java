...
public class AmazonClash_Balance_Check_WinAmount_AddedToBalance_InCredits {
	AppiumDriver<MobileElement> driver;

	public AmazonClash_Balance_Check_WinAmount_AddedToBalance_InCredits() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Amazon_Clash_slot_game_balance_transfer_button_credit_balance_form_spin_button_and_win_amount_in_credits() throws Throwable {
	...
	public void win_amount_should_get_added_to_the_credit_field_after_win_and_credit_should_get_increased_with_win_amount_in_Amazon_Clash_slot_game() throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
