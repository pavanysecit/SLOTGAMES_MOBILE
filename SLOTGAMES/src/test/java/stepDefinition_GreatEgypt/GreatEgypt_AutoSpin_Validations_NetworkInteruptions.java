...
public class GreatEgypt_AutoSpin_Validations_NetworkInteruptions {
	AppiumDriver<MobileElement> driver;

	public GreatEgypt_AutoSpin_Validations_NetworkInteruptions() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Great_Egypt_slot_game_balance_spin_button_wifi_turnOFF_and_ON_network_messages() throws Throwable {
	...
	public void user_is_addressed_with_valid_error_message_No_Internet_for_network_interuptions_in_Great_Egypt_slot_game() throws Throwable {
		 Thread.sleep(1000);
	}
	...
	public void user_is_addressed_with_valid_error_message_Disconnected_from_Server_for_longer_duration_network_interuptions_in_Great_Egypt_slot_game() throws Throwable {
		   Thread.sleep(2000);
		   driver.quit();
		}
	}
