...
public class GreatEgypt_Balance_FullAmount_AddedToGame_And_Reload_Option {
	AppiumDriver<MobileElement> driver;

	
	@Given("^Chrome browser, valid URL, valid login details, Great Egypt slot game, Full amount transfer from account to game\\.$")
...
//		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@name='Suribet"))); 
	...
	@Then("^Remaining balance should be transfered to main account balance in Great Egypt slot game$")
	public void remaining_balance_should_be_transfered_to_main_account_balance_in_Great_Egypt_slot_game() throws Throwable {
	   Thread.sleep(2000);
	   driver.quit();
	}
}
