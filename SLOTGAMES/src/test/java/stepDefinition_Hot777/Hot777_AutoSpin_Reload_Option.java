...
public class Hot777_AutoSpin_Reload_Option {
	AppiumDriver<MobileElement> driver;

	public Hot777_AutoSpin_Reload_Option() throws InterruptedException {
		this.driver = Hot777_URL_Login.getDriver();
		//this.driver = Hot777_URL_TryNow.getDriver();
	}
	
	@Given("^Chrome browser, valid URL, valid login details, Hot (\\d+) slot game, balance, Autospin button, browser hamburger reload button valid session invalid error message\\.$")
	public void chrome_browser_valid_URL_valid_login_details_Hot_slot_game_balance_Autospin_button_browser_hamburger_reload_button_valid_session_invalid_error_message(int arg1) throws Throwable {
	    
	}

	@When("^Open the Hot (\\d+) slot game by entering the valid URL in browser, enter the valid login details, select autospin button, click on  hamburger menu and reload the game session\\.$")
	public void open_the_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_autospin_button_click_on_hamburger_menu_and_reload_the_game_session(int arg1) throws Throwable {
	...
	@Then("^User should not able to resume to game and autospin should be terminated and informed with valid error message for session invalid in Hot (\\d+) slot game$")
	public void user_should_not_able_to_resume_to_game_and_autospin_should_be_terminated_and_informed_with_valid_error_message_for_session_invalid_in_Hot_slot_game(int arg1) throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}