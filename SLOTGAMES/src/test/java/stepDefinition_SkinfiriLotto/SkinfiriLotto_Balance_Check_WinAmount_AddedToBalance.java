...
public class SkinfiriLotto_Balance_Check_WinAmount_AddedToBalance {
	AppiumDriver<MobileElement> driver;

	public SkinfiriLotto_Balance_Check_WinAmount_AddedToBalance() throws InterruptedException {
