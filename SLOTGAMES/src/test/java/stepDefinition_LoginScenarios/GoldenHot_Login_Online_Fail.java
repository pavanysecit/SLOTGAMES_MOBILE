...
public class GoldenHot_Login_Online_Fail {
AppiumDriver<MobileElement> driver;
	
	@Given("^Chrome browser, valid URL, Go button, Invalid account id, valid password and login button$")
	public void chrome_browser_valid_URL_Go_button_Invalid_account_id_valid_password_and_login_button() throws Throwable {
	...
	public void open_the_chrome_browser_Enter_the_valid_URL_click_on_Go_button_click_on_golden_hot_game_enter_invalid_account_id_password_and_click_on_Login_butotn() throws Throwable {
		...
		driver.findElement(By.name("email")).sendKeys("test10");
		Thread.sleep(2000);
	...
	public void user_should_be_failed_to_login_the_website_post_entering_invalid_account_details() throws Throwable {
