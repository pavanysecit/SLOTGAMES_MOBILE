...
public class GoldenHot_Login_Email_Success {
AppiumDriver<MobileElement> driver;
	
	@Given("^Chrome browser, valid URL, Go button, valid email id, valid password and login button$")
	public void chrome_browser_valid_URL_Go_button_valid_email_id_valid_password_and_login_button() throws Throwable {
	...
	public void open_the_chrome_browser_Enter_the_valid_URL_click_on_Go_button_click_on_golden_hot_game_enter_valid_email_id_password_and_click_on_Login_butotn() throws Throwable {
		...
		driver.findElement(By.name("email")).sendKeys("JIMBRAHIM@HOTMAIL.COM");
		Thread.sleep(2000);
	...
	public void user_should_be_able_to_login_to_website_successfully_post_entering_valid_email_account_details_and_balance_should_be_displayed() throws Throwable {
