...
public class PerfectGems_ResumeFeature_DisabledOption_WithoutWin {
	AppiumDriver<MobileElement> driver;

	public PerfectGems_ResumeFeature_DisabledOption_WithoutWin() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Perfect_Gems_slot_slot_game_bet_type_denomination_balance_spin_button_Gamble_screen_Gamble_collect() throws Throwable {
	...
	public void open_the_Perfect_Gems_slot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_bet_type_denomination_click_on_spin_button_till_win_appears_and_gamble_screen_in_switched_and_click_on_collect_and_close_the_browser_and_again_load_to_the_game() throws Throwable {
	...
	public void resume_feature_should_not_be_enabled_and_land_on_the_game_screen_of_Perfect_Gems_slot_game() throws Throwable {
		Thread.sleep(1000);
	    driver.quit();
	}
}
