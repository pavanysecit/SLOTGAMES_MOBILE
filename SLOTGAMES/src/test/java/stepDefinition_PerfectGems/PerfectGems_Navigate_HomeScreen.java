...
public class PerfectGems_Navigate_HomeScreen {
	AppiumDriver<MobileElement> driver;

	public PerfectGems_Navigate_HomeScreen() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Perfect_Gems_slot_game_and_home_button() throws Throwable {
	...
	public void system_should_take_the_player_to_Home_page_after_clicking_on_home_button_from_Perfect_Gems_game() throws Throwable {
		Thread.sleep(1000);
	    driver.quit();
	}
}
