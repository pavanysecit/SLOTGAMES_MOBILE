...
public class PerfectGems_Balance_InsufficiantBalance_Validation {
	...
	public void chrome_browser_valid_URL_valid_login_details_Perfect_Gems_slot_game_balance_spin_button_and_validation_message_button_behavior() throws Throwable {
	...
	public void open_the_Perfect_Gems_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_till_balance_turns_to_zero_and_check_the_validation_message_with_buttons_behavior() throws Throwable {
		...
		if(driver.findElements(By.id("hud_BetPopup20.5")).size() != 0){
	...
	public void player_should_be_blocked_from_playing_the_game_when_there_is_no_balance_in_the_account_and_buttons_are_inactive_state_in_Perfect_Gems_game() throws Throwable {
		Thread.sleep(1000);
	    driver.quit();
	}
}
