...
public class PerfectGems_Balance_Credits_Calculations_Value3 {
	AppiumDriver<MobileElement> driver;

	public PerfectGems_Balance_Credits_Calculations_Value3() throws InterruptedException {
	...
	@Then("^Balance amound should be same as denomination (\\d+)\\.(\\d+) multiplies by credit balance in Perfect Gems slot game$")
	public void balance_amound_should_be_same_as_denomination_multiplies_by_credit_balance_in_Perfect_Gems_slot_game(int arg1, int arg2) throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
