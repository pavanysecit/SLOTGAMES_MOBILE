...
public class PerfectGems_ManualSpin_Validations_ButtonsBehavior {
	AppiumDriver<MobileElement> driver;

	public PerfectGems_ManualSpin_Validations_ButtonsBehavior() throws InterruptedException {
	...
	public void open_the_Perfect_Gems_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_option_and_check_behavior_of_different_buttons_in_different_scenarios() throws Throwable {
		...
		if(driver.findElements(By.id("hud_BetPopup20.5")).size() != 0){
			Assert.assertTrue(driver.findElements(By.id("hud_BetPopup20.5")).size() != 0);
