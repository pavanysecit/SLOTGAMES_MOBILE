...
public class PerfectGems_Gamble_GambleAmount_DoubleThan_WinAmount {
	AppiumDriver<MobileElement> driver;

	public PerfectGems_Gamble_GambleAmount_DoubleThan_WinAmount() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Perfect_Gems_slot_game_balance_spin_button_win_amount_gamble_button_gamble_amount_and_gamble_to_win_amount() throws Throwable {
	...
	public void open_the_Perfect_Gems_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_to_win_amount() throws Throwable {
	...
	public void gamble_To_Win_amount_should_be_double_than_Gamble_amount_in_the_gamble_page_of_the_Perfect_Gems_slot_game() throws Throwable {
		Thread.sleep(1000);
	    driver.quit();
	}
}
