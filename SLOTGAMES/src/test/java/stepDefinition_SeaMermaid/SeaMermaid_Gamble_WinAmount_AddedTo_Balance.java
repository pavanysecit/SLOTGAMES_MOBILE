...
public class SeaMermaid_Gamble_WinAmount_AddedTo_Balance {
	AppiumDriver<MobileElement> driver;

	public SeaMermaid_Gamble_WinAmount_AddedTo_Balance() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Sea_Mermaid_slot_game_balance_spin_button_win_amount_gamble_button_gamble_amount_red_button_black_button_and_gamble_status() throws Throwable {
	...
	public void open_the_Sea_Mermaid_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_spin_button_till_player_wins_click_on_gamble_button_click_on_red_or_black_button_and_check_the_balance_after_win() throws Throwable {
	...
	public void gamble_Win_amount_should_get_added_to_main_balance_after_status_displayed_as_WIN_and_gamble_page_should_get_closed_in_Sea_Mermaid_slot_game() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
