...
public class SeaMermaid_TransferAmount_Scenarios_Zero_Empty_MoreBalance_Verify {
	...
	public void chrome_browser_valid_URL_valid_login_details_Sea_Mermaid_game_balance_text_field_to_transfer_balance_and_Ok_button() throws Throwable {
	...
	public void open_the_Sea_Mermaid_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_Play_button_enter_the_valid_amount_to_transfer_and_click_on_Ok_butotn() throws Throwable {
...
//        String formattedNumber = format.format(total);
	...
	public void the_exact_amount_entered_in_the_transfer_page_should_transfer_to_Sea_Mermaid_game_and_same_amount_should_get_displayed_on_the_balance_section() throws Throwable {
	...
	@Then("^An error should be displayed if the balance field is empty and player should be blocked from loading the Sea Mermaid game$")
	public void an_error_should_be_displayed_if_the_balance_field_is_empty_and_player_should_be_blocked_from_loading_the_Sea_Mermaid_game() throws Throwable {
	...
	public void an_error_should_be_displayed_if_balance_entered_was_zero_and_player_should_be_blocked_from_loading_the_Sea_Mermaid_game() throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
