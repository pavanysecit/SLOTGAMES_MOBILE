...
public class BouncingFruits_ResumeFeature_Play_With_LeftOver_Attempts {
	AppiumDriver<MobileElement> driver;

	public BouncingFruits_ResumeFeature_Play_With_LeftOver_Attempts() throws InterruptedException {
	...
	public void open_the_Bouncing_Fruits_slot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_bet_type_denomination_click_on_spin_button_till_win_appears_and_gamble_screen_in_switched_and_click_on_black_button_and_close_the_browser_and_again_login_to_the_game_with_new_browser() throws Throwable {
	...
	public void resume_feature_should_be_enabled_and_land_on_the_game_screen_and_verify_with_the_left_out_gamble_attempts_of_Bouncing_Fruits_slot_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Left over attempts should be  between (\\d+) to (\\d+) and the user is enabled to play the remaining attempts in Bouncing Fruits slot game$")
	public void left_over_attempts_should_be_between_to_and_the_user_is_enabled_to_play_the_remaining_attempts_in_Bouncing_Fruits_slot_game(int arg1, int arg2) throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
