...
public class BouncingFruits_TransferAmount_Scenarios_Zero_Empty_MoreBalance_Verify {
	...
	public void open_the_Bouncing_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_Play_button_enter_the_valid_amount_to_transfer_and_click_on_Ok_butotn() throws Throwable {
...
//        String formattedNumber = format.format(total);
	...
	public void player_should_be_blocked_from_loading_the_Bouncing_Fruits_game_when_the_amount_entered_in_the_transfer_page_is_more_than_the_available_balance() throws Throwable {
	...
	@Then("^The exact amount entered in the transfer page should transfer to Bouncing Fruits game and same amount should get displayed on the balance section$")
	public void the_exact_amount_entered_in_the_transfer_page_should_transfer_to_Bouncing_Fruits_game_and_same_amount_should_get_displayed_on_the_balance_section() throws Throwable {
	...
	@Then("^An error should be displayed if the balance field is empty and player should be blocked from loading the Bouncing Fruits game$")
	public void an_error_should_be_displayed_if_the_balance_field_is_empty_and_player_should_be_blocked_from_loading_the_Bouncing_Fruits_game() throws Throwable {
