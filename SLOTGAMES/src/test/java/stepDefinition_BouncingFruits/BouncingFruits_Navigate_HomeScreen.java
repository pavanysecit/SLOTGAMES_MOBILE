...
public class BouncingFruits_Navigate_HomeScreen {
	AppiumDriver<MobileElement> driver;

	public BouncingFruits_Navigate_HomeScreen() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Bouncing_Fruits_slot_game_and_home_button() throws Throwable {
	...
	public void system_should_take_the_player_to_Home_page_after_clicking_on_home_button_from_Bouncing_Fruits_game() throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
