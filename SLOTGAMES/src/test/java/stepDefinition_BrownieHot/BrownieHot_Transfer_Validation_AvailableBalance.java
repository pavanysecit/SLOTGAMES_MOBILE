...
public class BrownieHot_Transfer_Validation_AvailableBalance {
	AppiumDriver<MobileElement> driver;

	public BrownieHot_Transfer_Validation_AvailableBalance() throws InterruptedException {
	...
	@When("^Open the Brownie Hot slot game by entering the valid URL in browser, enter the valid login details, enter the amount greater than available balance and click on Ok butotn$")
	public void open_the_Brownie_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_enter_the_amount_greater_than_available_balance_and_click_on_Ok_butotn() throws Throwable {
