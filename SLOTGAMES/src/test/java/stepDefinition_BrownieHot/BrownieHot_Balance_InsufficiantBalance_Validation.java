...
public class BrownieHot_Balance_InsufficiantBalance_Validation {
	...
	public BrownieHot_Balance_InsufficiantBalance_Validation() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Brownie_Hot_slot_game_balance_spin_button_and_validation_message() throws Throwable {
	...
	public void open_the_Brownie_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_till_balance_turns_to_zero_and_check_the_validation_message() throws Throwable {
	...
	@Then("^Player should be blocked from playing the game when there is no balance in the account in Brownie Hot game$")
	public void player_should_be_blocked_from_playing_the_game_when_there_is_no_balance_in_the_account_in_Brownie_Hot_game() throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
