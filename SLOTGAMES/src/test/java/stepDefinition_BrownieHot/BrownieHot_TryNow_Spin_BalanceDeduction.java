...
public class BrownieHot_TryNow_Spin_BalanceDeduction {
	...
	public void chrome_browser_valid_URL_valid_login_details_Brownie_Hot_slot_game_try_now_button_balance_to_play_and_spin_button() throws Throwable {
	...
	public void open_the_Brownie_Hot_slot_game_by_entering_the_valid_URL_in_browser_click_on_try_now_button_and_click_on_spin_button() throws Throwable {
		...
		String expected1 = "4,988.00";
		Assert.assertEquals(actual1, expected1);
	}

	@Then("^Amount should get deducted from balance on click on spin button in try now page of Brownie Hotslot game$")
	public void amount_should_get_deducted_from_balance_on_click_on_spin_button_in_try_now_page_of_Brownie_Hotslot_game() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
