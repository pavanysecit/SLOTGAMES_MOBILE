...
public class BrownieHot_TryNow_VerifyBalance {
	AppiumDriver<MobileElement> driver;
	
	@Given("^Chrome browser, valid URL, valid login details, Brownie Hot slot game, try now button and balance to play$")
	public void chrome_browser_valid_URL_valid_login_details_Brownie_Hot_slot_game_try_now_button_and_balance_to_play() throws Throwable {
	...
	public void open_the_Brownie_Hot_slot_game_by_entering_the_valid_URL_in_browser_click_on_try_now_button() throws Throwable {
	...
	public void system_should_provide_five_thousand_as_balance_on_click_on_try_now_button_in_Brownie_Hot_slot_game() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
