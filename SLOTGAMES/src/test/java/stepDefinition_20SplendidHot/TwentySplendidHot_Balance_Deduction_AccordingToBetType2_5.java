...
public class TwentySplendidHot_Balance_Deduction_AccordingToBetType2_5 {
	...
	@Then("^Current Balance should get deducted by EIGHT as bet type is selected as (\\d+)\\.(\\d+) & bet value as EIGHT in (\\d+) Splendid Hot game$")
	public void current_Balance_should_get_deducted_by_EIGHT_as_bet_type_is_selected_as_bet_value_as_EIGHT_in_Splendid_Hot_game(int arg1, int arg2, int arg3) throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
