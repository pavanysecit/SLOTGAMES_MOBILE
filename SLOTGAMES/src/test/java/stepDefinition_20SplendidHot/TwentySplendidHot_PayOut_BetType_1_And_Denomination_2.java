...
public class TwentySplendidHot_PayOut_BetType_1_And_Denomination_2 {
	...
	public void open_the_Splendid_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_icon_to_open_payout_table_check_payout_amount_on_each_symbol_like_lemon_etc_click_on_back_button_select_bet_type_as_deominations_as_and_check_payout_amount(int arg1, int arg2, int arg3, int arg4, int arg5) throws Throwable {
		...
		if(me.getId().equals("35")){
			...
			System.out.println("Payout Value of 5 Plum or Watermelon symbol for denomination 0.4 is: " +Plum);
		...
		if(me.getId().equals("36")){
			...
			System.out.println("Payout Value of 4 Plum or Watermelon symbol for denomination 0.4 is: " +Plum1);
		...
		if(me.getId().equals("37")){
			...
			System.out.println("Payout Value of 3 Plum or Watermelon symbol for denomination 0.4 is: " +Plum2);
		...
		if(me.getId().equals("38")){
			...
			System.out.println("Payout Value of 5 Orange or Lemon or Cherry symbol for denomination 0.4 is: " +Orange);
		...
		if(me.getId().equals("39")){
			...
			System.out.println("Payout Value of 4 Orange or Lemon or Cherry symbol for denomination 0.4 is: " +Orange1);
		...
		if(me.getId().equals("40")){
			...
			System.out.println("Payout Value of 3 Orange or Lemon or Cherry symbol for denomination 0.4 is: " +Orange2);
