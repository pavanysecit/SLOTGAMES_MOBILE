...
public class TwentySplendidHot_Gamble_WinAmount_AddedTo_Balance_InCredits {
	AppiumDriver<MobileElement> driver;

	public TwentySplendidHot_Gamble_WinAmount_AddedTo_Balance_InCredits() throws InterruptedException {
