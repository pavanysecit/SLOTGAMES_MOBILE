...
public class SkinfiriMysterious_Balance_Credits_Calculations_Value2 {
	AppiumDriver<MobileElement> driver;

	public SkinfiriMysterious_Balance_Credits_Calculations_Value2() throws InterruptedException {
	...
	@Then("^Balance amound should be same as denomination (\\d+)\\.(\\d+) multiplies by credit in Skinfiri Mysterious game$")
	public void balance_amound_should_be_same_as_denomination_multiplies_by_credit_in_Skinfiri_Mysterious_game(int arg1, int arg2) throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
