...
public class SkinfiriMysterious_Check_MaximizeAndMinimize_Buttons {
	AppiumDriver<MobileElement> driver;

	public SkinfiriMysterious_Check_MaximizeAndMinimize_Buttons() throws InterruptedException {
