...
public class SkinfiriMysterious_URL_TryNow {
private static AppiumDriver<MobileElement> driver;
	
	//@Before
	public static void  SkinfiriMysterious_URL_TryNow() throws InterruptedException, MalformedURLException, FindFailed {
