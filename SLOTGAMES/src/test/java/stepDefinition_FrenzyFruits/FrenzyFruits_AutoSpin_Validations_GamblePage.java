...
public class FrenzyFruits_AutoSpin_Validations_GamblePage {
	AppiumDriver<MobileElement> driver;

	public FrenzyFruits_AutoSpin_Validations_GamblePage() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Frenzy_Fruits_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_check_for_buttons_behavior_functionality_after_navigating_from_gamble_page_to_game_page() throws Throwable {
	...
	public void open_the_Frenzy_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_behavior_of_different_buttons_after_navigating_from_gamble_page_to_game_page() throws Throwable {
		...
		driver.findElement(By.id("hud_txtBetAmount")).click();
		Thread.sleep(2000);
		MobileElement bet3_5= driver.findElement(By.id("hud_BetPopup410"));
