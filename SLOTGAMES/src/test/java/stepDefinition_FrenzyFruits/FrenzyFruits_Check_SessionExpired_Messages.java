...
public class FrenzyFruits_Check_SessionExpired_Messages {
	AppiumDriver<MobileElement> driver;

	public FrenzyFruits_Check_SessionExpired_Messages() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Frenzy_Fruits_slot_game_balance_spin_button_full_screen_landscape_mode_session_terminated_messages() throws Throwable {
		
	}

	@When("^Open the Frenzy Fruits slot game by entering the valid URL in browser, enter the valid login details, and full screen and change orientation of the screen, idle for more (\\d+)mins$")
	public void open_the_Frenzy_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_and_full_screen_and_change_orientation_of_the_screen_idle_for_more_mins(int arg1) throws Throwable {
	...
	public void user_is_addressed_with_valid_error_message_on_the_screen_Session_Expired_in_Frenzy_Fruits_slot_game() throws Throwable {
		Thread.sleep(1000);
	}
