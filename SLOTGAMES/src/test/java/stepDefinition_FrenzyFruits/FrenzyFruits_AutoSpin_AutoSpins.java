...
public class FrenzyFruits_AutoSpin_AutoSpins {
	AppiumDriver<MobileElement> driver;

	public FrenzyFruits_AutoSpin_AutoSpins() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Frenzy_Fruits_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_number_of_spins_left_message() throws Throwable {
	...
	public void system_should_keep_performing_the_spins_in_Frenzy_Fruits_slot_game() throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}