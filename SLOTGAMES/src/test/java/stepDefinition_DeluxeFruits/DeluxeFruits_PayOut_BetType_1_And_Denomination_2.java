...
public class DeluxeFruits_PayOut_BetType_1_And_Denomination_2 {
	AppiumDriver<MobileElement> driver;

	public DeluxeFruits_PayOut_BetType_1_And_Denomination_2() throws InterruptedException {
		this.driver = DeluxeFruits_URL_Login.getDriver();
		//this.driver = DeluxeFruits_URL_TryNow.getDriver();
	}
	
	@Given("^Chrome browser, valid URL, valid login details, Deluxe Fruits slot game, icon to open payout table, all symbols, max amount on each symbol like bell and bar, back button, bet type (\\d+)\\.(\\d+) and deominations (\\d+)\\.(\\d+)$")
	public void chrome_browser_valid_URL_valid_login_details_Deluxe_Fruits_slot_game_icon_to_open_payout_table_all_symbols_max_amount_on_each_symbol_like_bell_and_bar_back_button_bet_type_and_deominations(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		WebDriverWait wait1 = new WebDriverWait(driver, 80);
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("hud_Hud_txtBalance1"))); 
	}

	@When("^Open the Deluxe Fruits slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on icon to open payout table, check payout amount on each symbol like bell and bar, click on back button, select bet type as (\\d+)\\.(\\d+) & deominations as (\\d+)\\.(\\d+) and check payout amount$")
	public void open_the_Deluxe_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_icon_to_open_payout_table_check_payout_amount_on_each_symbol_like_bell_and_bar_click_on_back_button_select_bet_type_as_deominations_as_and_check_payout_amount(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		...
		if(me.getId().equals("28")){
			...
			System.out.println("Payout Value of 3 Seven symbols for denomination 0.4 is : " +seven1);
			Assert.assertEquals(actual4, expected4);
			Thread.sleep(1000);
		}
		...
		if(me.getId().equals("30")){
			...
			System.out.println("Payout Value of 5 Diamond symbols for denomination 0.4 is: " +diamond);
		...
		if(me.getId().equals("31")){
			...
			System.out.println("Payout Value of 4 Diamond symbols for denomination 0.4 is: " +diamond1);
		...
		if(me.getId().equals("32")){
			...
			System.out.println("Payout Value of 3 Diamond symbols for denomination 0.4 is: " +diamond2);
		...
		if(me.getId().equals("33")){
			...
			System.out.println("Payout Value of 5 Plum symbol for denomination 0.4: " +Plum);
		...
		if(me.getId().equals("34")){
			...
			System.out.println("Payout Value of 4 Plum symbol for denomination 0.4: " +Plum1);
		...
		if(me.getId().equals("35")){
			...
			System.out.println("Payout Value of 3 Plum symbol for denomination 0.4: " +Plum2);
		...
		if(me.getId().equals("36")){
			...
			System.out.println("Payout Value of 5 Double Bar symbol for denomination 0.4 is: " +Dbar);
		...
		if(me.getId().equals("37")){
			...
			System.out.println("Payout Value of 4 Double Bar symbol for denomination 0.4 is: " +Dbar1);
		...
		if(me.getId().equals("38")){
			...
			System.out.println("Payout Value of 3 Double Bar symbol for denomination 0.4 is: " +Dbar2);
		...
		if(me.getId().equals("39")){
			...
			System.out.println("Payout Value of 5 Cherry symbol for denomination 0.4 is: " +cherry);
		...
		if(me.getId().equals("40")){
			...
			System.out.println("Payout Value of 4 Cherry symbol for denomination 0.4 is: " +cherry1);
		...
		if(me.getId().equals("41")){
			...
			System.out.println("Payout Value of 3 Cherry symbol for denomination 0.4 is: " +cherry2);
		...
		if(me.getId().equals("42")){
			...
			System.out.println("Payout Value of 5 Orange symbol for denomination 0.4 is: " +orange);
		...
		if(me.getId().equals("43")){
			...
			System.out.println("Payout Value of 4 Orange symbol for denomination 0.4 is: " +orange1);
		...
		if(me.getId().equals("44")){
			...
			System.out.println("Payout Value of 3 Orange symbol for denomination 0.4 is: " +orange2);
		...
		if(me.getId().equals("48")){
			...
			String actual23 = "2 YSI";
			System.out.println("Payout Value of 5 Bell symbol for denomination 0.4 is: " +bell);
		...
		if(me.getId().equals("49")){
			...
			String actual24 = "0.6 YSI";
			System.out.println("Payout Value of 4 Bell symbol for denomination 0.4 is: " +bell1);
		...
		if(me.getId().equals("50")){
			...
			String actual25 = "0.3 YSI";
			System.out.println("Payout Value of 3 Bell symbol for denomination 0.4 is: " +bell2);
	...
	@Then("^System should display the Payout max amount on each symbol like bell and bar and payout max amount should get changed whenever player changes the bet type to (\\d+)\\.(\\d+) and deomination to (\\d+)\\.(\\d+) in Deluxe Fruits slot game on mobile$")
	public void system_should_display_the_Payout_max_amount_on_each_symbol_like_bell_and_bar_and_payout_max_amount_should_get_changed_whenever_player_changes_the_bet_type_to_and_deomination_to_in_Deluxe_Fruits_slot_game_on_mobile(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		Thread.sleep(2000);
	    driver.quit();
	}
}
