...
public class UltraHot_Balance_FullAmount_AddedToGame_And_Reload_Option {
	AppiumDriver<MobileElement> driver;

	public UltraHot_Balance_FullAmount_AddedToGame_And_Reload_Option() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Ultra_Hot_slot_game_Full_amount_transfer_from_account_to_game() throws Throwable {
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_game_and_transfer_full_amount_same_amount_has_to_reflect_in_game_balance_play_and_reload_the_game() throws Throwable {
	...
	public void remaining_balance_should_be_transfered_to_main_account_balance_in_Ultra_Hot_slot_game() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
