...
public class UltraHot_Gamble_Reload_Option {
	AppiumDriver<MobileElement> driver;

	public UltraHot_Gamble_Reload_Option() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Ultra_Hot_slot_game_balance_spin_button_gamble_page_browser_hamburger_reload_button_valid_session_invalid_error_message() throws Throwable {
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_spin_till_player_wins_gamble_screen_gamble_should_won_click_on_hamburger_menu_and_reload_the_game_session() throws Throwable {
	...
	public void user_should_not_able_to_resume_to_game_and_informed_with_valid_error_message_for_session_invalid_error_message_and_again_relauch_the_game_and_game_session_redirected_to_gamble_page_in_Ultra_Hot_slot_game() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
