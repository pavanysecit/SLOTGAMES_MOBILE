...
public class UltraHot_TryNow_Check_WinAmount_AddedToBalance {
	...
	public void chrome_browser_valid_URL_valid_login_details_Ultra_Hot_slot_game_try_now_button_balance_to_play_spin_button_and_win_amount() throws Throwable {
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_click_on_try_now_button_click_on_spin_button_till_player_win_and_check_the_balance_after_win() throws Throwable {
		List<MobileElement> balance = driver.findElementsByClassName("android.view.View");
		
		
		////Selecting bet type as 0.2 and default bet value will be 6
	...
	public void win_amount_should_get_added_to_the_balance_when_the_player_wins_in_try_now_page_of_Ultra_Hot_slot_game() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
