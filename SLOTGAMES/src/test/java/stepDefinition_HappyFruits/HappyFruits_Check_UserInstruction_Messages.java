...
public class HappyFruits_Check_UserInstruction_Messages {
	AppiumDriver<MobileElement> driver;

	public HappyFruits_Check_UserInstruction_Messages() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Happy_Fruits_slot_game_balance_spin_button_and_user_instruction_message() throws Throwable {
	...
	public void open_the_Happy_Fruits_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_and_check_the_user_instruction_messages() throws Throwable {
	...
	@Then("^User instruction message 'Good Luck' should be displayed after spin button is clicked in Happy Fruits slot game$")
	public void user_instruction_message_Good_Luck_should_be_displayed_after_spin_button_is_clicked_in_Happy_Fruits_slot_game() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
