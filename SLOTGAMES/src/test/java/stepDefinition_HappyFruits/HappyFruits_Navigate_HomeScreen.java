...
public class HappyFruits_Navigate_HomeScreen {
	AppiumDriver<MobileElement> driver;

	public HappyFruits_Navigate_HomeScreen() throws InterruptedException {
	...
	public void system_should_take_the_player_to_Home_page_after_clicking_on_home_button_from_Happy_Fruits_game() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
