...
public class HappyFruits_Balance_Deduction_AccordingToBetType4_5 {
	AppiumDriver<MobileElement> driver;

	public HappyFruits_Balance_Deduction_AccordingToBetType4_5() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Happy_Fruits_slot_game_bet_type_as_ONE_bet_value_as_one_hundred_balance_and_spin_button() throws Throwable {
	...
	public void open_the_Happy_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_ONE_bet_value_as_one_hundred_click_on_spin_button_and_check_the_balance() throws Throwable {
	...
	public void balance_should_get_deducted_by_one_hundred_as_bet_type_is_selected_as_ONE_in_Happy_Fruits_game() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
