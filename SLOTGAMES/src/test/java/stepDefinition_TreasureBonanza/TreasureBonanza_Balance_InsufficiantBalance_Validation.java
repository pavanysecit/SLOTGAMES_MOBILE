...
public class TreasureBonanza_Balance_InsufficiantBalance_Validation {
	AppiumDriver<MobileElement> driver;

	public TreasureBonanza_Balance_InsufficiantBalance_Validation() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Treasure_Bonanza_slot_game_balance_spin_button_and_validation_message() throws Throwable {
	...
	public void open_the_Treasure_Bonanza_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_till_balance_turns_to_zero_and_check_the_validation_message() throws Throwable {
	...
	public void player_should_be_blocked_from_playing_the_game_when_there_is_no_balance_in_the_account_in_Treasure_Bonanza_game() throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
