...
public class TreasureBonanza_Transfer_Validation_AvailableBalance {
	AppiumDriver<MobileElement> driver;

	public TreasureBonanza_Transfer_Validation_AvailableBalance() throws InterruptedException {
