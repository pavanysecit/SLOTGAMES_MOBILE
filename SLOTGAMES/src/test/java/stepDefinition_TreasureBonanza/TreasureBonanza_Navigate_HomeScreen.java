...
public class TreasureBonanza_Navigate_HomeScreen {
	AppiumDriver<MobileElement> driver;

	public TreasureBonanza_Navigate_HomeScreen() throws InterruptedException {
	...
	public void chrome_browser_valid_URL_valid_login_details_Treasure_Bonanza_slot_game_and_home_button() throws Throwable {
	...
	public void open_the_Treasure_Bonanza_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_and_click_on_home_button() throws Throwable {
	...
	public void system_should_take_the_player_to_Home_page_after_clicking_on_home_button_from_Treasure_Bonanza_game() throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
